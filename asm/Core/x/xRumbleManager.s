...
.global rumbleManager_esc__7_1174
rumbleManager_esc__7_1174:
	.skip 0x148
...
lbl_80055E88:
/* 80055E88 00052C88  80 6D 91 D0 */	lwz r3, xglobals@sda21(r13)
...
/* 80055EA8 00052CA8  3C 60 80 2D */	lis r3, _esc__2_stringBase0_19@ha
/* 80055EAC 00052CAC  38 63 23 A8 */	addi r3, r3, _esc__2_stringBase0_19@l
...
/* 80055ED8 00052CD8  C0 02 8C 1C */	lfs f0, _esc__2_991@sda21(r2)
...
/* 80055FC4 00052DC4  C0 02 8C 1C */	lfs f0, _esc__2_991@sda21(r2)
lbl_80055FC8:
...
/* 800560A8 00052EA8  C0 02 8C 1C */	lfs f0, _esc__2_991@sda21(r2)
...
/* 80056118 00052F18  C0 42 8C 1C */	lfs f2, _esc__2_991@sda21(r2)
...
/* 80056174 00052F74  C3 E2 8C 1C */	lfs f31, _esc__2_991@sda21(r2)
...
/* 8005621C 0005301C  C0 02 8C 1C */	lfs f0, _esc__2_991@sda21(r2)
...
lbl_80056274:
/* 80056274 00053074  C0 02 8C 24 */	lfs f0, _esc__2_1169@sda21(r2)
...
lbl_80056284:
/* 80056284 00053084  C0 02 8C 10 */	lfs f0, _esc__2_988@sda21(r2)
...
/* 80056294 00053094  C0 02 8C 14 */	lfs f0, _esc__2_989_0@sda21(r2)
...
/* 800562E4 000530E4  88 0D BC 78 */	lbz r0, init_esc__7_1175@sda21(r13)
/* 800562E8 000530E8  7C 00 07 75 */	extsb. r0, r0
/* 800562EC 000530EC  40 82 00 18 */	bne lbl_80056304
/* 800562F0 000530F0  3C 60 80 34 */	lis r3, rumbleManager_esc__7_1174@ha
/* 800562F4 000530F4  38 63 55 30 */	addi r3, r3, rumbleManager_esc__7_1174@l
/* 800562F8 000530F8  48 00 00 69 */	bl __ct__Q27xRumble7ManagerFv
/* 800562FC 000530FC  38 00 00 01 */	li r0, 1
/* 80056300 00053100  98 0D BC 78 */	stb r0, init_esc__7_1175@sda21(r13)
lbl_80056304:
/* 80056304 00053104  80 01 00 14 */	lwz r0, 0x14(r1)
/* 80056308 00053108  3C 60 80 34 */	lis r3, rumbleManager_esc__7_1174@ha
/* 8005630C 0005310C  38 63 55 30 */	addi r3, r3, rumbleManager_esc__7_1174@l
...
/* 800563A4 000531A4  80 6D 91 D0 */	lwz r3, xglobals@sda21(r13)
