...
/* 80073EFC 00070CFC  80 6D BA E4 */	lwz r3, gActiveHeap-_SDA_BASE_(r13)
...
/* 80073F18 00070D18  80 6D BA E4 */	lwz r3, gActiveHeap-_SDA_BASE_(r13)
...
/* 80073F2C 00070D2C  80 6D BA E4 */	lwz r3, gActiveHeap-_SDA_BASE_(r13)
...
/* 80073F44 00070D44  80 6D BA E4 */	lwz r3, gActiveHeap-_SDA_BASE_(r13)
...
/* 80073F58 00070D58  38 82 90 F4 */	addi r4, r2, lbl_803D2E14-_SDA2_BASE_
...
/* 80073F84 00070D84  80 6D 91 C4 */	lwz r3, FB_XRES-_SDA_BASE_(r13)
/* 80073F88 00070D88  80 8D 91 C8 */	lwz r4, FB_YRES-_SDA_BASE_(r13)
/* 80073F8C 00070D8C  4B F9 18 E1 */	bl iCameraCreate__Fiii
/* 80073F90 00070D90  90 6D C0 00 */	stw r3, sPipeCamera-_SDA_BASE_(r13)
/* 80073F94 00070D94  7C 64 1B 78 */	mr r4, r3
/* 80073F98 00070D98  80 7D 00 00 */	lwz r3, 0(r29)
/* 80073F9C 00070D9C  90 6D BF FC */	stw r3, sPipeWorld-_SDA_BASE_(r13)
...
/* 80074340 00071140  80 6D BF FC */	lwz r3, sPipeWorld-_SDA_BASE_(r13)
/* 80074344 00071144  80 8D C0 00 */	lwz r4, sPipeCamera-_SDA_BASE_(r13)
/* 80074348 00071148  48 20 38 D9 */	bl RpWorldRemoveCamera
/* 8007434C 0007114C  80 6D C0 00 */	lwz r3, sPipeCamera-_SDA_BASE_(r13)
/* 80074350 00071150  4B F9 16 CD */	bl iCameraDestroy__FP8RwCamera
/* 80074354 00071154  38 00 00 00 */	li r0, 0
/* 80074358 00071158  90 0D BF FC */	stw r0, sPipeWorld-_SDA_BASE_(r13)
/* 8007435C 0007115C  90 0D C0 00 */	stw r0, sPipeCamera-_SDA_BASE_(r13)
...
/* 8007445C 0007125C  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
/* 80074488 00071288  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
/* 800744B8 000712B8  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
/* 800744E4 000712E4  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
/* 80074598 00071398  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
/* 800745B8 000713B8  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
iEnvSetup__FP4iEnv:
/* 800745E4 000713E4  90 6D C0 04 */	stw r3, lastEnv-_SDA_BASE_(r13)
...
/* 80074608 00071408  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
/* 80074620 00071420  80 AD E6 54 */	lwz r5, RwEngineInstance-_SDA_BASE_(r13)
...
lbl_80074698:
/* 80074698 00071498  93 AD C0 04 */	stw r29, lastEnv-_SDA_BASE_(r13)
lbl_8007469C:
...
/* 800746C0 000714C0  83 ED C0 04 */	lwz r31, lastEnv-_SDA_BASE_(r13)
...
/* 800746D8 000714D8  80 8D B7 20 */	lwz r4, globalCamera-_SDA_BASE_(r13)
/* 800746DC 000714DC  28 04 00 00 */	cmplwi r4, 0
/* 800746E0 000714E0  41 82 00 28 */	beq lbl_80074708
/* 800746E4 000714E4  80 0D BF F8 */	lwz r0, sBeginDrawFX-_SDA_BASE_(r13)
...
/* 800746F8 000714F8  80 8D B7 20 */	lwz r4, globalCamera-_SDA_BASE_(r13)
/* 800746FC 000714FC  48 20 34 D1 */	bl RpWorldAddCamera
/* 80074700 00071500  38 00 00 00 */	li r0, 0
/* 80074704 00071504  90 0D BF F8 */	stw r0, sBeginDrawFX-_SDA_BASE_(r13)
lbl_80074708:
