...
/* 80073C78 00070A78  80 AD BF E0 */	lwz r5, lastSetFBMSK-_SDA_BASE_(r13)
/* 80073C7C 00070A7C  7C A3 F8 78 */	andc r3, r5, r31
/* 80073C80 00070A80  7C 9E 1B 78 */	or r30, r4, r3
/* 80073C84 00070A84  93 CD BF E0 */	stw r30, lastSetFBMSK-_SDA_BASE_(r13)
...
/* 80073D18 00070B18  80 8D 91 C4 */	lwz r4, FB_XRES-_SDA_BASE_(r13)
...
/* 80073DC4 00070BC4  80 6D E6 EC */	lwz r3, _RwDlRenderMode-_SDA_BASE_(r13)
...
/* 80073DE0 00070BE0  80 6D E6 EC */	lwz r3, _RwDlRenderMode-_SDA_BASE_(r13)
/* 80073DE4 00070BE4  B0 03 00 0C */	sth r0, 0xc(r3)
/* 80073DE8 00070BE8  80 6D E6 EC */	lwz r3, _RwDlRenderMode-_SDA_BASE_(r13)
...
/* 80073E20 00070C20  38 6D BF F0 */	addi r3, r13, xfbDisp-_SDA_BASE_
/* 80073E24 00070C24  38 8D BF F4 */	addi r4, r13, xfbCopy-_SDA_BASE_
...
/* 80073E50 00070C50  80 8D 91 C4 */	lwz r4, FB_XRES-_SDA_BASE_(r13)
/* 80073E54 00070C54  38 6D BF E4 */	addi r3, r13, xfb-_SDA_BASE_
/* 80073E58 00070C58  80 0D 91 C8 */	lwz r0, FB_YRES-_SDA_BASE_(r13)
/* 80073E5C 00070C5C  80 AD BF F4 */	lwz r5, xfbCopy-_SDA_BASE_(r13)
/* 80073E60 00070C60  7C 84 01 D6 */	mullw r4, r4, r0
/* 80073E64 00070C64  38 05 00 1F */	addi r0, r5, 0x1f
/* 80073E68 00070C68  90 AD BF E4 */	stw r5, xfb-_SDA_BASE_(r13)
/* 80073E6C 00070C6C  54 00 00 34 */	rlwinm r0, r0, 0, 0, 0x1a
/* 80073E70 00070C70  90 0D BF E4 */	stw r0, xfb-_SDA_BASE_(r13)
...
iXFBalloc__FUi:
/* 80073E94 00070C94  38 AD BF E4 */	addi r5, r13, xfb-_SDA_BASE_
