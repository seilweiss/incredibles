...
/* 800DD8F8 000DA6F8  C8 42 A3 30 */	lfd f2, _esc__2_954_0-_SDA2_BASE_(r2)
/* 800DD8FC 000DA6FC  90 61 00 0C */	stw r3, 0xc(r1)
/* 800DD900 000DA700  C0 02 A3 28 */	lfs f0, _esc__2_952_0-_SDA2_BASE_(r2)
...
/* 800DD938 000DA738  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DD984 000DA784  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DD9D0 000DA7D0  C0 42 A3 40 */	lfs f2, _esc__2_1001-_SDA2_BASE_(r2)
/* 800DD9D4 000DA7D4  C0 02 A3 3C */	lfs f0, _esc__2_1000_4-_SDA2_BASE_(r2)
...
/* 800DD9F0 000DA7F0  C0 42 A3 40 */	lfs f2, _esc__2_1001-_SDA2_BASE_(r2)
/* 800DD9F4 000DA7F4  C0 02 A3 3C */	lfs f0, _esc__2_1000_4-_SDA2_BASE_(r2)
...
/* 800DDA10 000DA810  C0 42 A3 40 */	lfs f2, _esc__2_1001-_SDA2_BASE_(r2)
/* 800DDA14 000DA814  C0 02 A3 3C */	lfs f0, _esc__2_1000_4-_SDA2_BASE_(r2)
/* 800DDA18 000DA818  80 7D 00 14 */	lwz r3, 0x14(r29)
/* 800DDA1C 000DA81C  EC 42 00 7A */	fmadds f2, f2, f1, f0
/* 800DDA20 000DA820  C0 02 A3 44 */	lfs f0, _esc__2_1002_2-_SDA2_BASE_(r2)
...
lbl_800DDA44:
/* 800DDA44 000DA844  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DDA58 000DA858  C0 02 A3 44 */	lfs f0, _esc__2_1002_2-_SDA2_BASE_(r2)
...
lbl_800DDA6C:
/* 800DDA6C 000DA86C  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DDA80 000DA880  C0 02 A3 44 */	lfs f0, _esc__2_1002_2-_SDA2_BASE_(r2)
...
lbl_800DDA94:
/* 800DDA94 000DA894  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DDADC 000DA8DC  C0 42 A3 48 */	lfs f2, _esc__2_1007_0-_SDA2_BASE_(r2)
/* 800DDAE0 000DA8E0  90 01 00 14 */	stw r0, 0x14(r1)
/* 800DDAE4 000DA8E4  C0 62 A3 40 */	lfs f3, _esc__2_1001-_SDA2_BASE_(r2)
...
/* 800DDB04 000DA904  C0 42 A3 40 */	lfs f2, _esc__2_1001-_SDA2_BASE_(r2)
/* 800DDB08 000DA908  90 01 00 14 */	stw r0, 0x14(r1)
/* 800DDB0C 000DA90C  C0 62 A3 4C */	lfs f3, _esc__2_1012_3-_SDA2_BASE_(r2)
...
/* 800DDB2C 000DA92C  C0 42 A3 38 */	lfs f2, _esc__2_975_0-_SDA2_BASE_(r2)
/* 800DDB30 000DA930  90 01 00 14 */	stw r0, 0x14(r1)
/* 800DDB34 000DA934  C0 62 A3 3C */	lfs f3, _esc__2_1000_4-_SDA2_BASE_(r2)
...
/* 800DDB84 000DA984  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DDC00 000DAA00  C0 02 A3 38 */	lfs f0, _esc__2_975_0-_SDA2_BASE_(r2)
...
/* 800DDC24 000DAA24  C0 02 A3 50 */	lfs f0, _esc__2_1088_1-_SDA2_BASE_(r2)
/* 800DDC28 000DAA28  D0 1E 00 00 */	stfs f0, 0(r30)
/* 800DDC2C 000DAA2C  4B FF FC B1 */	bl leGetRandom__Fv
/* 800DDC30 000DAA30  C0 02 A3 54 */	lfs f0, _esc__2_1089_1-_SDA2_BASE_(r2)
...
/* 800DDC40 000DAA40  C0 42 A3 5C */	lfs f2, _esc__2_1091_1-_SDA2_BASE_(r2)
/* 800DDC44 000DAA44  C0 02 A3 58 */	lfs f0, _esc__2_1090_1-_SDA2_BASE_(r2)
...
/* 800DDC54 000DAA54  C0 02 A3 54 */	lfs f0, _esc__2_1089_1-_SDA2_BASE_(r2)
/* 800DDC58 000DAA58  EC 00 00 72 */	fmuls f0, f0, f1
/* 800DDC5C 000DAA5C  D0 1E 00 0C */	stfs f0, 0xc(r30)
lbl_800DDC60:
/* 800DDC60 000DAA60  C0 02 A3 60 */	lfs f0, _esc__2_1092_1-_SDA2_BASE_(r2)
