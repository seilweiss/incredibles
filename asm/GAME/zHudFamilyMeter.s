...
/* 801F3930 001F0730  C0 02 D8 48 */	lfs f0, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F399C 001F079C  3C 80 80 2F */	lis r4, $$2stringBase0_157@ha
...
/* 801F39AC 001F07AC  38 64 CD 68 */	addi r3, r4, $$2stringBase0_157@l
/* 801F39B0 001F07B0  4B E7 92 71 */	bl xStrHash__FPCc
/* 801F39B4 001F07B4  3C 80 80 2F */	lis r4, $$2stringBase0_157@ha
/* 801F39B8 001F07B8  7C 7F 1B 78 */	mr r31, r3
/* 801F39BC 001F07BC  38 84 CD 68 */	addi r4, r4, $$2stringBase0_157@l
...
/* 801F3A04 001F0804  C0 62 D8 4C */	lfs f3, $$2895_0-_SDA2_BASE_(r2)
/* 801F3A08 001F0808  38 A1 00 10 */	addi r5, r1, 0x10
/* 801F3A0C 001F080C  C0 42 D8 50 */	lfs f2, $$2896_0-_SDA2_BASE_(r2)
/* 801F3A10 001F0810  38 C1 00 08 */	addi r6, r1, 8
/* 801F3A14 001F0814  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
/* 801F3A18 001F0818  38 80 00 00 */	li r4, 0
/* 801F3A1C 001F081C  C0 02 D8 54 */	lfs f0, $$2897_0-_SDA2_BASE_(r2)
...
/* 801F3A54 001F0854  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3A64 001F0864  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
/* 801F3A68 001F0868  4B FB 57 7D */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3A6C 001F086C  C0 62 D8 4C */	lfs f3, $$2895_0-_SDA2_BASE_(r2)
/* 801F3A70 001F0870  38 A1 00 10 */	addi r5, r1, 0x10
/* 801F3A74 001F0874  C0 42 D8 58 */	lfs f2, $$2898_0-_SDA2_BASE_(r2)
/* 801F3A78 001F0878  38 C1 00 08 */	addi r6, r1, 8
/* 801F3A7C 001F087C  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
/* 801F3A80 001F0880  38 80 00 01 */	li r4, 1
/* 801F3A84 001F0884  C0 02 D8 5C */	lfs f0, $$2899-_SDA2_BASE_(r2)
...
/* 801F3ABC 001F08BC  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3ACC 001F08CC  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3AFC 001F08FC  C0 62 D8 60 */	lfs f3, $$2900-_SDA2_BASE_(r2)
/* 801F3B00 001F0900  38 A1 00 10 */	addi r5, r1, 0x10
/* 801F3B04 001F0904  C0 42 D8 64 */	lfs f2, $$2901-_SDA2_BASE_(r2)
/* 801F3B08 001F0908  38 C1 00 08 */	addi r6, r1, 8
/* 801F3B0C 001F090C  C0 22 D8 68 */	lfs f1, $$2902_2-_SDA2_BASE_(r2)
/* 801F3B10 001F0910  38 80 00 00 */	li r4, 0
/* 801F3B14 001F0914  C0 02 D8 48 */	lfs f0, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3B4C 001F094C  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3B5C 001F095C  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
/* 801F3B60 001F0960  4B FB 56 85 */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3B64 001F0964  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3B78 001F0978  C0 62 D8 6C */	lfs f3, $$2903_2-_SDA2_BASE_(r2)
/* 801F3B7C 001F097C  38 A1 00 10 */	addi r5, r1, 0x10
/* 801F3B80 001F0980  C0 42 D8 5C */	lfs f2, $$2899-_SDA2_BASE_(r2)
/* 801F3B84 001F0984  38 C1 00 08 */	addi r6, r1, 8
/* 801F3B88 001F0988  C0 22 D8 70 */	lfs f1, $$2904_1-_SDA2_BASE_(r2)
/* 801F3B8C 001F098C  38 80 00 01 */	li r4, 1
/* 801F3B90 001F0990  C0 02 D8 74 */	lfs f0, $$2905_3-_SDA2_BASE_(r2)
...
/* 801F3BC8 001F09C8  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3BD8 001F09D8  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
/* 801F3BDC 001F09DC  4B FB 56 09 */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3BE0 001F09E0  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3BF4 001F09F4  C0 62 D8 78 */	lfs f3, $$2906_2-_SDA2_BASE_(r2)
/* 801F3BF8 001F09F8  38 A1 00 10 */	addi r5, r1, 0x10
/* 801F3BFC 001F09FC  C0 42 D8 7C */	lfs f2, $$2907_4-_SDA2_BASE_(r2)
/* 801F3C00 001F0A00  38 C1 00 08 */	addi r6, r1, 8
/* 801F3C04 001F0A04  C0 22 D8 80 */	lfs f1, $$2908_1-_SDA2_BASE_(r2)
/* 801F3C08 001F0A08  38 80 00 02 */	li r4, 2
/* 801F3C0C 001F0A0C  C0 02 D8 84 */	lfs f0, $$2909_1-_SDA2_BASE_(r2)
...
/* 801F3C44 001F0A44  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3C54 001F0A54  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
/* 801F3C58 001F0A58  4B FB 55 8D */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3C5C 001F0A5C  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3CB8 001F0AB8  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3E48 001F0C48  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3E58 001F0C58  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3E68 001F0C68  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3E7C 001F0C7C  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3E8C 001F0C8C  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3E9C 001F0C9C  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
/* 801F3EA0 001F0CA0  4B FB 53 45 */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3EA4 001F0CA4  C0 22 D8 88 */	lfs f1, $$2954_5-_SDA2_BASE_(r2)
/* 801F3EA8 001F0CA8  38 80 00 01 */	li r4, 1
/* 801F3EAC 001F0CAC  C0 42 D8 8C */	lfs f2, $$2955_3-_SDA2_BASE_(r2)
...
/* 801F3ECC 001F0CCC  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3EDC 001F0CDC  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
...
/* 801F3EEC 001F0CEC  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
/* 801F3EF0 001F0CF0  4B FB 52 F5 */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3EF4 001F0CF4  C0 22 D8 90 */	lfs f1, $$2956_3-_SDA2_BASE_(r2)
/* 801F3EF8 001F0CF8  38 80 00 01 */	li r4, 1
/* 801F3EFC 001F0CFC  C0 42 D8 8C */	lfs f2, $$2955_3-_SDA2_BASE_(r2)
...
/* 801F3F1C 001F0D1C  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3F2C 001F0D2C  C0 22 D8 4C */	lfs f1, $$2895_0-_SDA2_BASE_(r2)
...
/* 801F3F3C 001F0D3C  C0 22 D8 48 */	lfs f1, $$2883_1-_SDA2_BASE_(r2)
/* 801F3F40 001F0D40  4B FB 52 A5 */	bl set_layer_alpha__Q24xhud12image_widgetFUif
/* 801F3F44 001F0D44  C0 22 D8 94 */	lfs f1, $$2957_3-_SDA2_BASE_(r2)
/* 801F3F48 001F0D48  38 80 00 01 */	li r4, 1
/* 801F3F4C 001F0D4C  C0 42 D8 8C */	lfs f2, $$2955_3-_SDA2_BASE_(r2)
