...
/* 800CCB10 000C9910  90 0D C6 E0 */	stw r0, ribbonCount__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCB28 000C9928  90 6D C6 E4 */	stw r3, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
/* 800CCB2C 000C992C  38 A0 00 00 */	li r5, 0
/* 800CCB30 000C9930  80 6D BA E4 */	lwz r3, gActiveHeap-_SDA_BASE_(r13)
/* 800CCB34 000C9934  80 8D C6 E0 */	lwz r4, ribbonCount__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
/* 800CCB38 000C9938  4B F7 D0 29 */	bl xMemAlloc__FUiUii
/* 800CCB3C 000C993C  90 6D C6 E8 */	stw r3, ribbonInUse__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
/* 800CCB40 000C9940  3B C0 00 00 */	li r30, 0
/* 800CCB44 000C9944  3B E0 00 00 */	li r31, 0
/* 800CCB48 000C9948  48 00 00 44 */	b lbl_800CCB8C
lbl_800CCB4C:
/* 800CCB4C 000C994C  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCB74 000C9974  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
lbl_800CCB8C:
/* 800CCB8C 000C998C  80 0D C6 E0 */	lwz r0, ribbonCount__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
lbl_800CCBD4:
/* 800CCBD4 000C99D4  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCBE8 000C99E8  80 6D C6 E8 */	lwz r3, ribbonInUse__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
lbl_800CCC08:
/* 800CCC08 000C9A08  80 0D C6 E0 */	lwz r0, ribbonCount__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
lbl_800CCC34:
/* 800CCC34 000C9A34  80 6D C6 E8 */	lwz r3, ribbonInUse__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCC44 000C9A44  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
lbl_800CCC68:
/* 800CCC68 000C9A68  80 0D C6 E0 */	lwz r0, ribbonCount__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCC80 000C9A80  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCC90 000C9A90  80 6D C6 E8 */	lwz r3, ribbonInUse__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
/* 800CCC94 000C9A94  38 00 00 01 */	li r0, 1
/* 800CCC98 000C9A98  7C 03 F9 AE */	stbx r0, r3, r31
/* 800CCC9C 000C9A9C  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCCEC 000C9AEC  4B F6 BF 35 */	bl __ml__Q236tier_queue$$0Q29xFXRibbon10joint_data$$18iteratorCFv
...
/* 800CCD28 000C9B28  80 0D C6 E4 */	lwz r0, ribbonPool__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
/* 800CCD2C 000C9B2C  38 A0 00 00 */	li r5, 0
/* 800CCD30 000C9B30  80 8D C6 E8 */	lwz r4, ribbonInUse__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
...
/* 800CCD58 000C9B58  80 AD C6 E0 */	lwz r5, ribbonCount__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
/* 800CCD5C 000C9B5C  28 05 00 01 */	cmplwi r5, 1
/* 800CCD60 000C9B60  41 80 00 10 */	blt lbl_800CCD70
/* 800CCD64 000C9B64  80 6D C6 E8 */	lwz r3, ribbonInUse__27$$2unnamed$$2zFXRibbonPool_cpp$$2-_SDA_BASE_(r13)
