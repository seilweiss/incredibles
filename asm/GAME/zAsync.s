...
/* 80174904 00171704  90 6D D3 78 */	stw r3, screen__6zAsync-_SDA_BASE_(r13)
...
/* 8017491C 0017171C  80 6D 91 C4 */	lwz r3, FB_XRES-_SDA_BASE_(r13)
/* 80174920 00171720  80 8D 91 C8 */	lwz r4, FB_YRES-_SDA_BASE_(r13)
/* 80174924 00171724  4B E9 0F 49 */	bl iCameraCreate__Fiii
/* 80174928 00171728  90 6D D3 68 */	stw r3, cam__6zAsync-_SDA_BASE_(r13)
/* 8017492C 0017172C  38 60 00 80 */	li r3, 0x80
/* 80174930 00171730  48 0F B8 69 */	bl RpLightCreate
/* 80174934 00171734  90 6D D3 6C */	stw r3, light__6zAsync-_SDA_BASE_(r13)
/* 80174938 00171738  48 11 FB B5 */	bl RwFrameCreate
/* 8017493C 0017173C  38 00 00 03 */	li r0, 3
/* 80174940 00171740  90 6D D3 70 */	stw r3, frame__6zAsync-_SDA_BASE_(r13)
/* 80174944 00171744  38 A1 00 20 */	addi r5, r1, 0x20
/* 80174948 00171748  38 82 BC F4 */	addi r4, r2, lbl_803D5A14-_SDA2_BASE_
...
/* 80174988 00171788  90 6D D3 74 */	stw r3, world__6zAsync-_SDA_BASE_(r13)
/* 8017498C 0017178C  80 6D D3 6C */	lwz r3, light__6zAsync-_SDA_BASE_(r13)
/* 80174990 00171790  90 81 00 18 */	stw r4, 0x18(r1)
/* 80174994 00171794  80 8D D3 70 */	lwz r4, frame__6zAsync-_SDA_BASE_(r13)
...
/* 801749B4 001717B4  80 6D D3 6C */	lwz r3, light__6zAsync-_SDA_BASE_(r13)
/* 801749B8 001717B8  38 81 00 08 */	addi r4, r1, 8
/* 801749BC 001717BC  48 0F B1 11 */	bl RpLightSetColor
/* 801749C0 001717C0  80 6D D3 70 */	lwz r3, frame__6zAsync-_SDA_BASE_(r13)
...
/* 801749D0 001717D0  80 6D D3 74 */	lwz r3, world__6zAsync-_SDA_BASE_(r13)
/* 801749D4 001717D4  80 8D D3 6C */	lwz r4, light__6zAsync-_SDA_BASE_(r13)
/* 801749D8 001717D8  48 10 34 61 */	bl RpWorldAddLight
/* 801749DC 001717DC  80 6D D3 74 */	lwz r3, world__6zAsync-_SDA_BASE_(r13)
/* 801749E0 001717E0  80 8D D3 68 */	lwz r4, cam__6zAsync-_SDA_BASE_(r13)
/* 801749E4 001717E4  48 10 31 E9 */	bl RpWorldAddCamera
/* 801749E8 001717E8  80 6D D3 78 */	lwz r3, screen__6zAsync-_SDA_BASE_(r13)
...
/* 80174A28 00171828  80 6D D3 78 */	lwz r3, screen__6zAsync-_SDA_BASE_(r13)
...
/* 80174A4C 0017184C  80 6D D3 74 */	lwz r3, world__6zAsync-_SDA_BASE_(r13)
/* 80174A50 00171850  80 8D D3 6C */	lwz r4, light__6zAsync-_SDA_BASE_(r13)
/* 80174A54 00171854  48 10 34 85 */	bl RpWorldRemoveLight
/* 80174A58 00171858  80 6D D3 70 */	lwz r3, frame__6zAsync-_SDA_BASE_(r13)
/* 80174A5C 0017185C  48 11 FB BD */	bl RwFrameDestroy
/* 80174A60 00171860  80 6D D3 6C */	lwz r3, light__6zAsync-_SDA_BASE_(r13)
/* 80174A64 00171864  48 0F B6 D5 */	bl RpLightDestroy
/* 80174A68 00171868  80 6D D3 74 */	lwz r3, world__6zAsync-_SDA_BASE_(r13)
/* 80174A6C 0017186C  80 8D D3 68 */	lwz r4, cam__6zAsync-_SDA_BASE_(r13)
/* 80174A70 00171870  48 10 31 B1 */	bl RpWorldRemoveCamera
/* 80174A74 00171874  80 6D D3 74 */	lwz r3, world__6zAsync-_SDA_BASE_(r13)
/* 80174A78 00171878  48 10 11 39 */	bl RpWorldDestroy
/* 80174A7C 0017187C  80 6D D3 68 */	lwz r3, cam__6zAsync-_SDA_BASE_(r13)
/* 80174A80 00171880  4B E9 0F 9D */	bl iCameraDestroy__FP8RwCamera
/* 80174A84 00171884  38 00 00 00 */	li r0, 0
/* 80174A88 00171888  90 0D D3 68 */	stw r0, cam__6zAsync-_SDA_BASE_(r13)
/* 80174A8C 0017188C  90 0D D3 6C */	stw r0, light__6zAsync-_SDA_BASE_(r13)
/* 80174A90 00171890  90 0D D3 70 */	stw r0, frame__6zAsync-_SDA_BASE_(r13)
/* 80174A94 00171894  90 0D D3 74 */	stw r0, world__6zAsync-_SDA_BASE_(r13)
...
/* 80174B50 00171950  80 6D E6 54 */	lwz r3, RwEngineInstance-_SDA_BASE_(r13)
...
lbl_80174B90:
/* 80174B90 00171990  80 6D D3 68 */	lwz r3, cam__6zAsync-_SDA_BASE_(r13)
...
/* 80174BA0 001719A0  80 6D D3 68 */	lwz r3, cam__6zAsync-_SDA_BASE_(r13)
/* 80174BA4 001719A4  4B E9 1A 05 */	bl RwCameraBeginUpdateWrapper__FP8RwCamera
/* 80174BA8 001719A8  80 6D D3 78 */	lwz r3, screen__6zAsync-_SDA_BASE_(r13)
...
/* 80174BC8 001719C8  80 6D D3 78 */	lwz r3, screen__6zAsync-_SDA_BASE_(r13)
...
lbl_80174BDC:
/* 80174BDC 001719DC  80 6D D3 68 */	lwz r3, cam__6zAsync-_SDA_BASE_(r13)
/* 80174BE0 001719E0  48 11 E0 45 */	bl RwCameraEndUpdate
/* 80174BE4 001719E4  80 6D D3 68 */	lwz r3, cam__6zAsync-_SDA_BASE_(r13)
...
/* 80174C08 00171A08  80 6D B8 08 */	lwz r3, gFrameCount-_SDA_BASE_(r13)
/* 80174C0C 00171A0C  38 03 00 01 */	addi r0, r3, 1
/* 80174C10 00171A10  90 0D B8 08 */	stw r0, gFrameCount-_SDA_BASE_(r13)
...
/* 80174C54 00171A54  80 6D BA EC */	lwz r3, scratch_mem_used-_SDA_BASE_(r13)
