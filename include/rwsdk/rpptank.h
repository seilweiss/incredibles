...
enum RpPTankDataFlags
{
    ...
    rpPTANKDFLAGSIZE = ((
        int)0x00000004), /**<Uses a size per particle. This flag is ignored if the particle is a matrix.*/
    ...
    rpPTANKDFLAGVTX2TEXCOORDS =
        ((int)0x00000080), /**<Uses Top-Left and Bottom-Right Texture coordinates*/
    ...
    rpPTANKDFLAGCNSVTX2TEXCOORDS =
        ((int)0x00080000), /**<Uses constant Top-Left and Bottom-Right Texture coordinates*/
...
#define rpPTANKDFLAGFATPARTICLES                                                                   \
    (rpPTANKDFLAGPOSITION | rpPTANKDFLAGSIZE | rpPTANKDFLAG2DROTATE | rpPTANKDFLAGVTXCOLOR |       \
...
enum RpPTankDataLockFlags
{
    ...
    rpPTANKLFLAGVTXCOLOR =
        ((int)0x00000040), /**<Access the colors buffer (when using a color per vertex) */
    rpPTANKLFLAGVTX2TEXCOORDS =
        ((int)0x00000080), /**<Access the Top-Left and Bottom-Right Texture coordinates buffer*/
    rpPTANKLFLAGVTX4TEXCOORDS =
        ((int)0x00000100), /**<Access the texture UVs Buffer (when using a color per vertex)*/
...
enum RpPTankInstanceFlags
{
    ...
    rpPTANKIFLAGCNSVTX2TEXCOORDS =
        ((int)0x00080000), /**<Constant vertex 2 Texture coordinates changed*/
    rpPTANKIFLAGCNSVTX4TEXCOORDS =
        ((int)0x00100000), /**<Constant vertex 4 Texture coordinates changed*/
    /*    free                       = ((int)0x00200000),    */
    /*    free                       = ((int)0x00400000),    */
...
#define GLOBALPTANKPLUGINDATA() (*RWPLUGINOFFSET(void*, RwEngineInstance, _rpPTankGlobalsOffset))
...
extern RwBool RpAtomicIsPTank(RpAtomic* atomic);

extern const RpPTankFormatDescriptor* RpPTankAtomicGetDataFormat(RpAtomic* atomic);

/*
 * Particles Management API **************************************************
 */

#define RpPTankAtomicGetActiveParticlesCountMacro(_atm) (RPATOMICPTANKPLUGINDATA(_atm)->actPCount)

#define RpPTankAtomicGetMaximumParticlesCountMacro(_atm) (RPATOMICPTANKPLUGINDATA(_atm)->maxPCount)
...
#define RpPTankAtomicGetMaterialMacro(atm_) (RpGeometryGetMaterial(RpAtomicGetGeometry(atm_), 0))
...
#define RpPTankAtomicGetBlendModesMacro(atm_, src_, dst_)                                          \
    MACRO_START                                                                                    \
    {                                                                                              \
        *src_ = (RwBlendFunction)(RPATOMICPTANKPLUGINDATA(atm_)->publicData.srcBlend);             \
        *dst_ = (RwBlendFunction)(RPATOMICPTANKPLUGINDATA(atm_)->publicData.dstBlend);             \
    }                                                                                              \
    MACRO_STOP
...
#define RpPTankAtomicGetConstantSizeMacro(atm_) (&RPATOMICPTANKPLUGINDATA(atm_)->publicData.cSize)
...
#define RpPTankAtomicSetConstantColorMacro(atm_, col_)                                             \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            (void)RpMaterialSetColor(RpGeometryGetMaterial(RpAtomicGetGeometry(atm_), 0),          \
...
#define RpPTankAtomicSetConstantVtxColorMacro(atm_, col_)                                          \
    MACRO_START                                                                                    \
    {                                                                                              \
        memcpy(RPATOMICPTANKPLUGINDATA(atm_)->publicData.cVtxColor, col_, sizeof(RwRGBA) * 4);     \
...
#define RpPTankAtomicSetConstantVtx2TexCoordsMacro(atm_, uv_)                                      \
    MACRO_START                                                                                    \
    {                                                                                              \
        memcpy(RPATOMICPTANKPLUGINDATA(atm_)->publicData.cUV, uv_, sizeof(RwTexCoords) * 2);       \
...
#define RpPTankAtomicSetConstantVtx4TexCoordsMacro(atm_, uv_)                                      \
    MACRO_START                                                                                    \
    {                                                                                              \
        memcpy(RPATOMICPTANKPLUGINDATA(atm_)->publicData.cUV, uv_, sizeof(RwTexCoords) * 4);       \
...
extern RwInt32 RpPTankAtomicGetActiveParticlesCount(RpAtomic* atomic);

extern RwInt32 RpPTankAtomicGetMaximumParticlesCount(RpAtomic* atomic);

extern void RpPTankAtomicSetActiveParticlesCount(RpAtomic* atomic, RwInt32 count);

extern void RpPTankAtomicSetTexture(RpAtomic* atomic, RwTexture* texture);

extern RwTexture* RpPTankAtomicGetTexture(RpAtomic* atomic);

extern RpAtomic* RpPTankAtomicSetMaterial(RpAtomic* atomic, RpMaterial* material);

extern RpMaterial* RpPTankAtomicGetMaterial(RpAtomic* atomic);

extern void RpPTankAtomicSetBlendModes(RpAtomic* atomic, RwBlendFunction srcBlendMode,
                                       RwBlendFunction dstBlendMode);

extern void RpPTankAtomicGetBlendModes(RpAtomic* atomic, RwBlendFunction* srcBlendMode,
                                       RwBlendFunction* dstBlendMode);

extern void RpPTankAtomicSetVertexAlpha(RpAtomic* atomic, RwBool vtxAlphaState);

extern RwBool RpPTankAtomicGetVertexAlpha(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantCenter(RpAtomic* atomic, RwV2d* center);

const RwV2d* RpPTankAtomicGetConstantCenter(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantSize(RpAtomic* atomic, RwV2d* size);

extern const RwV2d* RpPTankAtomicGetConstantSize(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantRotate(RpAtomic* atomic, RwReal rotate);

extern RwReal RpPTankAtomicGetConstantRotate(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantMatrix(RpAtomic* atomic, RwMatrix* matrix);

extern const RwMatrix* RpPTankAtomicGetConstantMatrix(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantColor(RpAtomic* atomic, RwRGBA* color);

extern const RwRGBA* RpPTankAtomicGetConstantColor(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantVtxColor(RpAtomic* atomic, RwRGBA* color);

extern const RwRGBA* RpPTankAtomicGetConstantVtxColor(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantVtx2TexCoords(RpAtomic* atomic, RwTexCoords* UVs);

extern const RwTexCoords* RpPTankAtomicGetConstantVtx2TexCoords(RpAtomic* atomic);

extern void RpPTankAtomicSetConstantVtx4TexCoords(RpAtomic* atomic, RwTexCoords* UVs);

extern const RwTexCoords* RpPTankAtomicGetConstantVtx4TexCoords(RpAtomic* atomic);
#else

#define RpPTankAtomicGetActiveParticlesCount(atm_) RpPTankAtomicGetActiveParticlesCountMacro(atm_)

#define RpPTankAtomicGetMaximumParticlesCount(atm_) RpPTankAtomicGetMaximumParticlesCountMacro(atm_)

#define RpPTankAtomicSetActiveParticlesCount(atm_, cnt_)                                           \
    RpPTankAtomicSetActiveParticlesCountMacro(atm_, cnt_)

#define RpPTankAtomicSetTexture(atm_, tex_) RpPTankAtomicSetTextureMacro(atm_, tex_)

#define RpPTankAtomicGetTexture(atm_) RpPTankAtomicGetTextureMacro(atm_)

extern RpAtomic* RpPTankAtomicSetMaterial(RpAtomic* atomic, RpMaterial* material);

#define RpPTankAtomicGetMaterial(atm_) RpPTankAtomicGetMaterialMacro(atm_)
...
#define RpPTankAtomicSetVertexAlpha(atm_, vas_) RpPTankAtomicSetVertexAlphaMacro(atm_, vas_)

#define RpPTankAtomicGetVertexAlpha(atm_) RpPTankAtomicGetVertexAlphaMacro(atm_)

#define RpPTankAtomicSetConstantCenter(atm_, ctr_) RpPTankAtomicSetConstantCenterMacro(atm_, ctr_)

#define RpPTankAtomicGetConstantCenter(atm_) RpPTankAtomicGetConstantCenterMacro(atm_)

#define RpPTankAtomicSetConstantSize(atm_, size_) RpPTankAtomicSetConstantSizeMacro(atm_, size_)

#define RpPTankAtomicGetConstantSize(atm_) RpPTankAtomicGetConstantSizeMacro(atm_)

#define RpPTankAtomicSetConstantRotate(atm_, rot_) RpPTankAtomicSetConstantRotateMacro(atm_, rot_)

#define RpPTankAtomicGetConstantRotate(atm_) RpPTankAtomicGetConstantRotateMacro(atm_)

#define RpPTankAtomicSetConstantMatrix(atm_, mtx_) RpPTankAtomicSetConstantMatrixMacro(atm_, mtx_)

#define RpPTankAtomicGetConstantMatrix(atm_) RpPTankAtomicGetConstantMatrixMacro(atm_)

#define RpPTankAtomicSetConstantColor(atm_, col_) RpPTankAtomicSetConstantColorMacro(atm_, col_)

#define RpPTankAtomicGetConstantColor(atm_) RpPTankAtomicGetConstantColorMacro(atm_)

#define RpPTankAtomicSetConstantVtxColor(atm_, _col)                                               \
    RpPTankAtomicSetConstantVtxColorMacro(atm_, _col)

#define RpPTankAtomicGetConstantVtxColor(atm_) RpPTankAtomicGetConstantVtxColorMacro(atm_)

#define RpPTankAtomicSetConstantVtx2TexCoords(atm_, uv_)                                           \
    RpPTankAtomicSetConstantVtx2TexCoordsMacro(atm_, uv_)

#define RpPTankAtomicGetConstantVtx2TexCoords(atm_) RpPTankAtomicGetConstantVtx2TexCoordsMacro(atm_)

#define RpPTankAtomicSetConstantVtx4TexCoords(atm_, uv_)                                           \
    RpPTankAtomicSetConstantVtx4TexCoordsMacro(atm_, uv_)

#define RpPTankAtomicGetConstantVtx4TexCoords(atm_) RpPTankAtomicGetConstantVtx4TexCoordsMacro(atm_)
...
extern void* RpPTankAtomicLockByIndex(RpAtomic* atomic, RwInt32 idx, RwUInt32 dataFlags,
                                      RpPTankLockFlags lockFlag);
