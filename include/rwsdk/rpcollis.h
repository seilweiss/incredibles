...
extern RpCollTree* _rpCollTreeCreate(RwUInt16 numEntries, RwUInt16 numSplits, RwBBox* bbox,
                                     RwUInt32 flags);

extern void _rpCollTreeDestroy(RpCollTree* tree);

/* 
 *  Streaming
 */
extern RwUInt32 _rpCollTreeStreamGetSize(const RpCollTree* tree);

extern const RpCollTree* _rpCollTreeStreamWrite(const RpCollTree* tree, RwStream* stream);

extern RpCollTree* _rpCollTreeStreamRead(RwStream* stream);

#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))

extern RwUInt16* RpCollTreeGetEntryMap(RpCollTree* tree);
...
extern RwBool RpSectorBBoxItFinished(RpSectorBBoxIt* it);

extern RwBool RpSectorLineItFinished(RpSectorLineIt* it);

extern RwBool RpCollSectorBBoxItFinished(RpCollSectorBBoxIt* it);

extern RwBool RpCollSectorLineItFinished(RpCollSectorLineIt* it);
...
extern void RpSectorBBoxItInit(RpSectorBBoxIt* it, RpWorld* world, RwBBox* bbox);

extern RpWorldSector* RpSectorBBoxItFindNextWorldSector(RpSectorBBoxIt* it);

extern void RpSectorLineItInit(RpSectorLineIt* it, RpWorld* world, RwLine* line, RwV3d* padding);

extern RpWorldSector* RpSectorLineItFindNextWorldSector(RpSectorLineIt* it);

extern void RpSectorLineItSetFarClip(RpSectorLineIt* it, RwReal value);

/*
 *  RpCollSector iterators 
 */

extern void RpCollSectorBBoxItInit(RpCollSectorBBoxIt* it, RpCollTree* tree, RwBBox* outerBBox,
                                   RwBBox* innerBBox);

extern void RpCollSectorBBoxItFindNextEntries(RpCollSectorBBoxIt* it, RwUInt16* start,
                                              RwUInt16* count, RwUInt32* clipFlags);

extern void RpCollSectorLineItInit(RpCollSectorLineIt* it, RpCollTree* tree, RwLine* line,
                                   RwV3d* padding);

extern void RpCollSectorLineItInitFromSectorIt(RpCollSectorLineIt* it, RpCollTree* tree,
                                               RpSectorLineIt* sectIt);

extern void RpCollSectorLineItFindNextEntries(RpCollSectorLineIt* it, RwUInt16* start,
                                              RwUInt16* count);

extern void RpCollSectorLineItSetFarClip(RpCollSectorLineIt* it, RwReal value);
 ...
 *  Worlds
 */
extern RwBool RpCollisionWorldQueryData(RpWorld* world);

extern RpWorld* RpCollisionWorldDestroyData(RpWorld* world);

/*
 *  World Sectors  
 */

extern RpWorldSector* RpCollisionWorldSectorDestroyData(RpWorldSector* worldSector);

extern RwBool RpCollisionWorldSectorQueryData(RpWorldSector* worldSector);

#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))
extern RpCollTree* RpCollisionWorldSectorGetCollTree(RpWorldSector* worldSector);
#endif /* (defined(RWDEBUG) || defined(RWSUPPRESSINLINE)) */

extern RpWorldSector* _rpCollisionWorldSectorSetCollTree(RpWorldSector* worldSector,
                                                         RpCollTree* collTree);
/*
 *  Geometries
 */

extern RpGeometry* RpCollisionGeometryDestroyData(RpGeometry* geometry);

extern RwBool RpCollisionGeometryQueryData(RpGeometry* geometry);

#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))
extern RpCollTree* RpCollisionGeometryGetCollTree(RpGeometry* geometry);
#endif /* (defined(RWDEBUG) || defined(RWSUPPRESSINLINE)) */

extern RpGeometry* _rpCollisionGeometrySetCollTree(RpGeometry* geometry, RpCollTree* collTree);
 ...
 * \see RpCollisionWorldBuildData
 */
typedef void* (*RpCollisionBuildSortCallBack)(void* object, RpCollTree* tree, RwUInt16* sortTable,
                                              void* data);
...
extern RpCollisionBuildParam* RpCollisionBuildParamInitDefaults(RpCollisionBuildParam* param);

/* WorldSector collision data */
extern RpWorldSector* RpCollisionWorldSectorBuildData(RpWorldSector* worldSector,
                                                      RpCollisionBuildParam* param);

/* World collision data (convenience functions which call WorldSector functions) */
extern RpWorld* RpCollisionWorldBuildData(RpWorld* world, RpCollisionBuildParam* param);

/* Geometry collision data */
extern RpGeometry* RpCollisionGeometryBuildData(RpGeometry* geometry, RpCollisionBuildParam* param);
...
extern RpWorld* RpWorldForAllWorldSectorIntersections(RpWorld* world, RpIntersection* intersection,
                                                      RpIntersectionCallBackWorldSector callBack,
                                                      void* data);

extern RpWorld* RpWorldForAllAtomicIntersections(RpWorld* world, RpIntersection* intersection,
...
extern RpGeometry*
RpCollisionGeometryForAllIntersections(RpGeometry* geometry, RpIntersection* intersection,
