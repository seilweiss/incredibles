...
#define RtIntersectionLineTriangleMacro(_result, _lineStart, _lineDelta, _v0, _v1, _v2, _distance) \
    MACRO_START                                                                                    \
    {                                                                                              \
...
/* Line intersections */
extern RwBool RtIntersectionLineTriangle(const RwV3d* lineStart, const RwV3d* lineDelta,
                                         const RwV3d* v0, const RwV3d* v1, const RwV3d* v2,
                                         RwReal* distance);

/* Sphere intersections */
extern RwBool RtIntersectionSphereTriangle(const RwSphere* sphere, const RwV3d* v0, const RwV3d* v1,
                                           const RwV3d* v2, RwV3d* normal, RwReal* distance);

/* BBox intersections */
extern RwBool RtIntersectionBBoxTriangle(const RwBBox* bbox, const RwV3d* v0, const RwV3d* v1,
                                         const RwV3d* v2);
