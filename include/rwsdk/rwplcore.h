    ...
    {                                                                                              \
        ...
        { /* |x| < 0.5 */                                                                          \
            ...
            {                                                                                      \
                ...
                p = z *                                                                            \
                    (_RW_pS0 +                                                                     \
                     z * (_RW_pS1 + z * (_RW_pS2 + z * (_RW_pS3 + z * (_RW_pS4 + z * _RW_pS5))))); \
                q = _RW_one + z * (_RW_qS1 + z * (_RW_qS2 + z * (_RW_qS3 + z * _RW_qS4)));         \
                r = p / q;                                                                         \
...
#define RWV4DALIGNMENT(_v4d) (!(((rwV4DALIGNMENT)-1) & ((RwUInt32)(_v4d))))
...
#define _CLIENT_TAG (0xFFFF & (rwPLUGIN_ID))
#endif /* (defined(rwPLUGIN_ID)) */

#if (!defined(_CLIENT_TAG))
#define _CLIENT_TAG (0xFFFF & (MAKECHUNKID(rwVENDORID_CRITERIONTK, 0x00)))
...
#define RwMalloc(_s, _h)                                                                           \
    (_rwMemoryLastAllocFile = __FILE__, _rwMemoryLastAllocLine = __LINE__,                         \
...
extern const RwChar* RwMemoryGetLastAllocFile(void);

extern RwUInt32 RwMemoryGetLastAllocLine(void);
...
extern RwFreeList* _rwFreeListCreate(RwInt32 entrySize, RwInt32 entriesPerBlock, RwInt32 alignment,
                                     RwUInt32 hint, const RwChar* fileCreate, RwUInt32 lineCreate);

#define RwFreeListCreate(entrySize, entriesPerBlock, alignment, hint)                              \
    _rwFreeListCreate(entrySize, entriesPerBlock, alignment, hint, __FILE__, __LINE__)
#else /* (defined(RWDEBUG) && !defined(DOXYGEN)) */
...
#define RwFreeListAlloc(_f, _h) memalign(((_f)->alignment), (_f)->entrySize)

#else /* ((defined(__MWERKS__) || defined(__GNUC__)) && defined(__R5900__)) */

#define RwFreeListAlloc(_f, _h) RwMalloc(((_f)->entrySize), (_h))
...
typedef RwBool (*rwCustomStreamFnWrite)(void* data, const void* buffer,
...
extern RwStream* _rwStreamInitialize(RwStream* stream, RwBool rwOwned, RwStreamType type,
...
#define rwstrdup(_result, _string)                                                                 \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            _result = (RwChar*)RwMalloc((rwstrlen(_string) + 1) * sizeof(RwChar),                  \
 ...
 * API Functions.
 */
extern void RwChunkGroupSetFreeListCreateParams(RwInt32 blockSize, RwInt32 numBlocksToPrealloc);

extern RwChunkGroup* RwChunkGroupCreate(void);

extern RwBool RwChunkGroupDestroy(RwChunkGroup* grp);

extern RwChunkGroup* RwChunkGroupBeginStreamRead(RwStream* stream);

extern RwChunkGroup* RwChunkGroupEndStreamRead(RwChunkGroup* grp, RwStream* stream);

extern const RwChunkGroup* RwChunkGroupBeginStreamWrite(const RwChunkGroup* grp, RwStream* stream);

extern const RwChunkGroup* RwChunkGroupEndStreamWrite(const RwChunkGroup* grp, RwStream* stream);

extern RwUInt32 RwChunkGroupStreamGetSize(const RwChunkGroup* grp);

extern RwChunkGroup* RwChunkGroupSetName(RwChunkGroup* grp, const RwChar* name);
...
extern const RwPluginRegistry* _rwPluginRegistryDeInitObject(const RwPluginRegistry* reg,
                                                             void* object);
extern const RwPluginRegistry* _rwPluginRegistryCopyObject(const RwPluginRegistry* reg,
                                                           void* dstObject, const void* srcObject);

#ifdef RWDEBUG
extern RwBool _rwPluginRegistryValidateObject(const RwPluginRegistry* reg, const void* object);
extern void _rwPluginRegistryPlaceValidationCodes(const RwPluginRegistry* reg, void* object);
...
#define RWMATRIXALIGNMENT(_mat) (!(((rwMATRIXALIGNMENT)-1) & ((RwUInt32)(_mat))))
...
typedef void(RWASMCALL* rwMatrixMultFn)(RwMatrix* dstMat, const RwMatrix* matA,
                                        const RwMatrix* matB);
...
/* Functions for debug */
extern void RwMatrixCopy(RwMatrix* dstMatrix, const RwMatrix* srcMatrix);

extern void RwMatrixSetIdentity(RwMatrix* matrix);
...
extern const RwMatrix* RwMatrixQueryRotate(const RwMatrix* matrix, RwV3d* unitAxis, RwReal* angle,
                                           RwV3d* center);
...
extern RwV3d* RwMatrixGetRight(RwMatrix* matrix);

extern RwV3d* RwMatrixGetUp(RwMatrix* matrix);

extern RwV3d* RwMatrixGetAt(RwMatrix* matrix);

extern RwV3d* RwMatrixGetPos(RwMatrix* matrix);
...
#define rwMat04Det(_mAA, _mAB, _mAC, _mAD, _mBA, _mBB, _mBC, _mBD, _mCA, _mCB, _mCC, _mCD, _mDA,   \
                   _mDB, _mDC, _mDD)                                                               \
...
MACRO_START                                                                                        \
    {                                                                                              \
        ...
        determinant.nReal = ((_rAA) * (_mAA) + (_rAB) * (_mBA));                                   \
                                                                                                   \
        {                                                                                          \
            const RwReal normalize =                                                               \
                ((determinant.nInt != 0) ? (((RwReal)1) / determinant.nReal) : ((RwReal)1));       \
                                                                                                   \
            (_rAA) *= normalize;                                                                   \
            (_rAB) *= normalize;                                                                   \
                                                                                                   \
...
#define rwMat03Inv(_rAA, _rAB, _rAC, _rBA, _rBB, _rBC, _rCA, _rCB, _rCC, _mAA, _mAB, _mAC, _mBA,   \
                   _mBB, _mBC, _mCA, _mCB, _mCC)                                                   \
    MACRO_START                                                                                    \
    {                                                                                              \
        RwSplitBits determinant;                                                                   \
                                                                                                   \
...
#define rwMat04Inv(_rAA, _rAB, _rAC, _rAD, _rBA, _rBB, _rBC, _rBD, _rCA, _rCB, _rCC, _rCD, _rDA,   \
                   _rDB, _rDC, _rDD, _mAA, _mAB, _mAC, _mAD, _mBA, _mBB, _mBC, _mBD, _mCA, _mCB,   \
                   _mCC, _mCD, _mDA, _mDB, _mDC, _mDD)                                             \
    MACRO_START                                                                                    \
    {                                                                                              \
        RwSplitBits determinant;                                                                   \
                                                                                                   \
        ...
        (_rAD) = -rwMat03Det(_mAB, _mAC, _mAD, _mBB, _mBC, _mBD, _mCB, _mCC, _mCD);                \
                                                                                                   \
        determinant.nReal =                                                                        \
            ((_rAA) * (_mAA) + (_rAB) * (_mBA) + (_rAC) * (_mCA) + (_rAD) * (_mDA));               \
                                                                                                   \
        {                                                                                          \
            const RwReal normalize =                                                               \
                ((determinant.nInt != 0) ? (((RwReal)1) / determinant.nReal) : ((RwReal)1));       \
            ...
            (_rAD) *= normalize;                                                                   \
                                                                                                   \
            (_rBA) =                                                                               \
                -rwMat03Det(_mBA, _mBC, _mBD, _mCA, _mCC, _mCD, _mDA, _mDC, _mDD) * normalize;     \
            (_rBB) = rwMat03Det(_mAA, _mAC, _mAD, _mCA, _mCC, _mCD, _mDA, _mDC, _mDD) * normalize; \
            (_rBC) =                                                                               \
                -rwMat03Det(_mAA, _mAC, _mAD, _mBA, _mBC, _mBD, _mDA, _mDC, _mDD) * normalize;     \
            ...
            (_rCB) =                                                                               \
                -rwMat03Det(_mAA, _mAB, _mAD, _mCA, _mCB, _mCD, _mDA, _mDB, _mDD) * normalize;     \
            (_rCC) = rwMat03Det(_mAA, _mAB, _mAD, _mBA, _mBB, _mBD, _mDA, _mDB, _mDD) * normalize; \
            (_rCD) =                                                                               \
                -rwMat03Det(_mAA, _mAB, _mAD, _mBA, _mBB, _mBD, _mCA, _mCB, _mCD) * normalize;     \
                                                                                                   \
            (_rDA) =                                                                               \
                -rwMat03Det(_mBA, _mBB, _mBC, _mCA, _mCB, _mCC, _mDA, _mDB, _mDC) * normalize;     \
            (_rDB) = rwMat03Det(_mAA, _mAB, _mAC, _mCA, _mCB, _mCC, _mDA, _mDB, _mDC) * normalize; \
            (_rDC) =                                                                               \
                -rwMat03Det(_mAA, _mAB, _mAC, _mBA, _mBB, _mBC, _mDA, _mDB, _mDC) * normalize;     \
...
#define RwRGBARealFromRwRGBAMacro(o, i)                                                            \
    MACRO_START                                                                                    \
    {                                                                                              \
        (o)->red = (((RwReal)(((i)->red))) * ((RwReal)((1.0 / 255.0))));                           \
        (o)->green = (((RwReal)(((i)->green))) * ((RwReal)((1.0 / 255.0))));                       \
        (o)->blue = (((RwReal)(((i)->blue))) * ((RwReal)((1.0 / 255.0))));                         \
        (o)->alpha = (((RwReal)(((i)->alpha))) * ((RwReal)((1.0 / 255.0))));                       \
    }                                                                                              \
    MACRO_STOP
...
#define RwRGBARealAdd(o, a, b) RwRGBARealAddMacro(o, a, b)

#define RwRGBARealSub(o, a, b) RwRGBARealSubMacro(o, a, b)

#define RwRGBARealScale(o, a, scale) RwRGBARealScaleMacro(o, a, scale)

#define RwRGBAFromRwRGBAReal(o, i) RwRGBAFromRwRGBARealMacro(o, i)

#define RwRGBARealFromRwRGBA(o, i) RwRGBARealFromRwRGBAMacro(o, i)

#else /* (! ( defined(RWDEBUG) || defined(RWSUPPRESSINLINE) )) */

/* Function versions for debug */
extern void RwRGBARealAdd(RwRGBAReal* result, const RwRGBAReal* source1, const RwRGBAReal* source2);

extern void RwRGBARealSub(RwRGBAReal* result, const RwRGBAReal* source1, const RwRGBAReal* source2);

extern void RwRGBARealScale(RwRGBAReal* result, const RwRGBAReal* source, RwReal scalar);

extern void RwRGBAFromRwRGBAReal(RwRGBA* result, const RwRGBAReal* source);

extern void RwRGBARealFromRwRGBA(RwRGBAReal* result, RwRGBA* source);
...
#define RwIm2DVertexClipRGBA(o, i, n, f)                                                           \
    ...
    {                                                                                              \
        const RwInt32 _factor = (RwFastRealToUInt32(i * (RwReal)(255))) & 255;                     \
                                                                                                   \
        (o)->emissiveColor =                                                                       \
            (((((RwIm2DVertexGetAlpha(f) - RwIm2DVertexGetAlpha(n)) * _factor) >> 8) +             \
              RwIm2DVertexGetAlpha(n))                                                             \
             << 24) |                                                                              \
            (((((RwIm2DVertexGetRed(f) - RwIm2DVertexGetRed(n)) * _factor) >> 8) +                 \
              RwIm2DVertexGetRed(n))                                                               \
             << 16) |                                                                              \
            (((((RwIm2DVertexGetGreen(f) - RwIm2DVertexGetGreen(n)) * _factor) >> 8) +             \
              RwIm2DVertexGetGreen(n))                                                             \
             << 8) |                                                                               \
            (((((RwIm2DVertexGetBlue(f) - RwIm2DVertexGetBlue(n)) * _factor) >> 8) +               \
...
#if (!defined(rwSqrtMacro))
#define rwSqrtMacro(_root, _input) (*(_root) = _rwSqrt(_input))
#endif /* (!defined(rwSqrtMacro)) */
...
#define RwQuadSin(_x) (rw4OVERPISQ * (((_x) < 0) ? ((rwPI + (_x)) * (_x)) : ((rwPI - (_x)) * (_x))))

#define RwQuadASin(_result, _s)                                                                    \
    (rwPIOVER2 * (((_s) < 0) ? (rwSqrtMacro((_result), 1.0f + (_s)) - 1) :                         \
                               (1 - rwSqrtMacro((_result), 1.0f - (_s)))))

#define RwQuadCos(_x)                                                                              \
    (rw4OVERPISQ * (((_x) < -rwPIOVER2) ?                                                          \
                        ((-rwPI3OVER2 - (_x)) * (-rwPIOVER2 - (_x))) :                             \
                        (((_x) < rwPIOVER2) ? ((rwPIOVER2 + (_x)) * (rwPIOVER2 - (_x))) :          \
                                              ((rwPIOVER2 - (_x)) * (rwPI3OVER2 - (_x))))))

#define RwQuadACos(_result, _c)                                                                    \
    (rwPIOVER2 * (((_c) < 0) ? (2.0f - rwSqrtMacro((_result), 1.0f + (_c))) :                      \
                               rwSqrtMacro((_result), 1.0f - (_c))))

#define RwQuadTan(_x) (rwPI3 * (_x) / (rwPI * rwPI - (_x) * (_x)*4.0f))

#define RwQuadATan(_result, _t)                                                                    \
    ((rwSqrtMacro((_result), (rwPI3OVER8 * rwPI3OVER8) + (_t) * (_t) * (rwPIOVER2 * rwPIOVER2)) -  \
      rwPI3OVER8) /                                                                                \
     (_t))
 ...
 */
typedef RwV3d* (*rwVectorMultFn)(RwV3d* pointOut, const RwV3d* pointIn, const RwMatrix* matrix);

typedef RwV3d* (*rwVectorsMultFn)(RwV3d* pointsOut, const RwV3d* pointsIn, RwInt32 numPoints,
...
extern void RwV2dAssign(RwV2d* out, const RwV2d* ina);
extern void RwV2dAdd(RwV2d* out, const RwV2d* ina, const RwV2d* inb);
extern void RwV2dLineNormal(RwV2d* out, const RwV2d* ina, const RwV2d* inb);
extern void RwV2dSub(RwV2d* out, const RwV2d* ina, const RwV2d* inb);
extern void RwV2dPerp(RwV2d* out, const RwV2d* in);
extern void RwV2dScale(RwV2d* out, const RwV2d* in, RwReal scalar);
extern RwReal RwV2dDotProduct(const RwV2d* ina, const RwV2d* inb);

extern void RwV3dAssign(RwV3d* out, const RwV3d* ina);
extern void RwV3dAdd(RwV3d* out, const RwV3d* ina, const RwV3d* inb);
extern void RwV3dSub(RwV3d* out, const RwV3d* ina, const RwV3d* inb);
extern void RwV3dScale(RwV3d* out, const RwV3d* in, RwReal scalar);
extern void RwV3dIncrementScaled(RwV3d* out, const RwV3d* in, RwReal scalar);
extern void RwV3dNegate(RwV3d* out, const RwV3d* in);
extern RwReal RwV3dDotProduct(const RwV3d* ina, const RwV3d* inb);
extern void RwV3dCrossProduct(RwV3d* out, const RwV3d* ina, const RwV3d* inb);
...
extern void* _rwSListGetNewEntries(RwSList* sList, RwInt32 entry, RwUInt32 hint);
...
#define rwSListCreate(size, hint) _rwSListCreate(size, hint)
#define rwSListDestroy(sList) _rwSListDestroy(sList)
#define rwSListDestroyArray(array) _rwSListDestroyArray(array)
#define rwSListDestroyEndEntries(sList, amount) _rwSListDestroyEndEntries(sList, amount)
#define rwSListDestroyEntry(sList, entry) _rwSListDestroyEntry(sList, entry)
#define rwSListEmpty(sList) _rwSListEmpty(sList)
#define rwSListGetArray(sList) _rwSListGetArray(sList)
#define rwSListGetEntry(sList, entry) _rwSListGetEntry(sList, entry)
#define rwSListGetNewEntry(sList, hint) _rwSListGetNewEntry(sList, hint)
#define rwSListGetNewEntries(sList, entry, hint) _rwSListGetNewEntries(sList, entry, hint)
#define rwSListGetNumEntries(sList) _rwSListGetNumEntries(sList)
#define rwSListReleaseArray(sList) _rwSListReleaseArray(sList)
#define rwSListToArray(sList) _rwSListToArray(sList)
#define rwSListGetBegin(sList) _rwSListGetBegin(sList)
#define rwSListGetEnd(sList) _rwSListGetEnd(sList)
...
extern RwSubSystemInfo* RwEngineGetSubSystemInfo(RwSubSystemInfo* subSystemInfo,
...
#define RwDebugSendMessage(type, funcName, message)                                                \
    _rwDebugSendMessage(type, RWSTRING(__FILE__), __LINE__, funcName, message)
...
extern RwChar* _rwdbsprintf(const RwChar* format, ...) __RWFORMAT__(printf, 1, 2);
#endif /* (!defined(DOXYGEN)) */
...
#define RWBYTEFINDMSB(a) (_rwMsbBit[(a)] - 1)

#define RWWORDFINDMSB(a) (((a)&0xff00) ? RWBYTEFINDMSB((a) >> 8) + 8 : RWBYTEFINDMSB(a))

#define RWLONGFINDMSB(a) (((a)&0xffff0000UL) ? RWWORDFINDMSB((a) >> 16) + 16 : RWWORDFINDMSB(a))
...
#define RWASSERTISTYPE(_f, _t) RWASSERT((((const RwObject*)(_f))->type) == (_t))
...
#define RWRESOURCESGLOBAL(var)                                                                     \
    (RWPLUGINOFFSET(rwResourcesGlobals, RwEngineInstance, resourcesModule.globalsOffset)->var)
#ifndef RWADOXYGENEXTERNAL
/**
 * \ingroup rwresources
 * \struct RwResEntry
...
#define RwResourcesUseResEntry(_ntry)                                                              \
    ((((_ntry)->link.next) ?                                                                       \
          (rwLinkListRemoveLLLink(&((_ntry)->link)),                                               \
           rwLinkListAddLLLink(RWRESOURCESGLOBAL(res.usedEntries), &((_ntry)->link))) :            \
          NULL),                                                                                   \
     (_ntry))
#endif /* ((!defined(RWDEBUG)) && (!defined(RWSUPPRESSINLINE))) */
...
extern RwMatrix* RwMatrixStreamRead(RwStream* stream, RwMatrix* matrix);
extern const RwMatrix* RwMatrixStreamWrite(const RwMatrix* matrix, RwStream* stream);
extern RwMatrixChunkInfo*
RwMatrixChunkInfoRead(RwStream* stream, RwMatrixChunkInfo* matrixChunkInfo, RwInt32* bytesRead);
...
/* Compatibility macro */
#define RwStreamWriteInt(_stream, _ints, _numBytes) RwStreamWriteInt32(_stream, _ints, _numBytes)

#define RwStreamReadInt(_stream, _ints, _numBytes) RwStreamReadInt32(_stream, _ints, _numBytes)

#define RwMemLittleEndian(_mem, _size) RwMemLittleEndian32(_mem, _size)

#define RwMemNative(_mem, _size) RwMemNative32(_mem, _size)
...
#define RwStreamWriteChunkHeader(stream, type, size)                                               \
    _rwStreamWriteVersionedChunkHeader(stream, type, size, rwLIBRARYCURRENTVERSION, RWBUILDNUMBER)
