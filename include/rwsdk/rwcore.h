...
#define RxClusterDecCursorByStride(_cluster, _stride)                                              \
    ((_cluster)->currentData = (void*)(((RwUInt8*)(_cluster)->currentData) - (_stride)))

#define RxClusterDecCursor(_cluster) RxClusterDecCursorByStride(_cluster, (_cluster)->stride)

#define RxClusterIncCursorByStride(_cluster, _stride)                                              \
    ((_cluster)->currentData = (void*)(((RwUInt8*)(_cluster)->currentData) + (_stride)))

#define RxClusterIncCursor(_cluster) RxClusterIncCursorByStride(_cluster, (_cluster)->stride)

#define RxClusterResetCursor(_cluster) ((_cluster)->currentData = (_cluster)->data)

#define RxClusterGetCursorData(_cluster, _type) ((_type*)(_cluster)->currentData)
...
#define RxPipelineClusterAssertAttributeSet(_cluster, _attributeSet)                               \
    RWASSERT((_cluster)->clusterRef->attributeSet != NULL &&                                       \
             rwstrcmp((_cluster)->clusterRef->attributeSet, (_attributeSet)) == 0)

#define RxPipelineNodeParamGetData(_param) ((_param)->dataParam)

#define RxPipelineNodeParamGetHeap(_param) ((_param)->heap)
...
#define RxHeapReset(heap) ((FALSE == (heap)->dirty) ? (TRUE) : (_rxHeapReset(heap)))
...
struct RxIoSpec
{
    ...
    RxClusterValidityReq*
        inputRequirements; /**< Requirements of the clusters of interest on input to the node */
...
struct RxPacket
{
    ...
    RwUInt16
        numClusters; /**< Maximum number of clusters simultanesouly present in the current pipeline */
...
struct RxPipelineNode
{
    ...
    RxPipelineCluster**
        slotClusterRefs; /**< For packets passing through this node, SlotClusterRefs[n]
    ...
    RwUInt32*
        inputToClusterSlot; /**< LUT to locate clusters of interest in packets passing through this pipeline Node */
...
struct RxPipelineRequiresCluster
{
    ...
    RxClusterValidityReq
        rqdOrOpt; /**< Cluster validity requirement (rxCLREQ_DONTWANT, rxCLREQ_REQUIRED or rxCLREQ_OPTIONAL) */
...
extern RwBool rxPipelinePluginsAttach(void);
...
extern RxCluster* RxClusterSetExternalData(RxCluster* cluster, void* data, RwInt32 stride,
                                           RwInt32 numElements);

extern RxCluster* RxClusterSetData(RxCluster* cluster, void* data, RwInt32 stride,
                                   RwInt32 numElements);
...
#define RxPacketDestroy(pk, self) (_rxPacketDestroy(pk))

#if (defined(RWDEBUG))
extern RxPacket* RxPacketFetch(RxPipelineNode* Node);
extern void RxPacketDispatch(RxPacket* packet, RwUInt32 output, RxPipelineNode* self);
extern void RxPacketDispatchToPipeline(RxPacket* packet, RxPipeline* dest, RxPipelineNode* self);
#else /* (defined(RWDEBUG)) */
#define RxPacketFetch(_self) rxPacketFetchMacro(_self)
#define RxPacketDispatch(_packet, _output, _self) rxPacketDispatchMacro(_packet, _output, _self)
...
extern RxCluster* RxClusterInitializeData(RxCluster* cluster, RwUInt32 numElements,
                                          RwUInt16 stride);
...
#define RXCLSLOT(PKT, CLIND) ((PKT)->inputToClusterSlot[(CLIND)])
...
extern RwUInt32 RxPipelineNodeSendConfigMsg(RxPipelineNode* dest, RwUInt32 msg, RwUInt32 intparam,
                                            void* ptrparam);

extern RxPipelineNode* RxPipelineNodeForAllConnectedOutputs(RxPipelineNode* node,
                                                            RxPipeline* pipeline,
...
extern RxPipelineCluster* RxPipelineNodeGetPipelineCluster(RxPipelineNode* node,
                                                           RwUInt32 clustersOfInterestIndex);

extern RwUInt32 RxPipelineClusterGetCreationAttributes(RxPipelineCluster* cluster);

extern RxPipelineCluster* RxPipelineClusterSetCreationAttributes(RxPipelineCluster* cluster,
...
extern void _rxEmbeddedPacketBetweenPipelines(RxPipeline* fromPipeline, RxPipeline* toPipeline);

extern RxPipelineNode* _rxEmbeddedPacketBetweenNodes(RxPipeline* pipeline, RxPipelineNode* nodeFrom,
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            RxPipelineNode* nextNode =                                                             \
                _rxEmbeddedPacketBetweenNodes(curPipeline, _self, (_output));                      \
            if (nextNode != NULL)                                                                  \
            {                                                                                      \
                RwUInt32 exitCode =                                                                \
                    nextNode->nodeDef->nodeMethods.nodeBody(nextNode, &(_rxExecCtxGlobal.params)); \
                /* Don't overwrite 'error' with 'success' */                                       \
                if (FALSE == exitCode)                                                             \
                    _rxExecCtxGlobal.exitCode = exitCode;                                          \
            }                                                                                      \
        }                                                                                          \
        if (curPipeline->embeddedPacketState > rxPKST_UNUSED /* !UNUSED and !PACKETLESS */)        \
        {                                                                                          \
...
#define rxPacketDispatchToPipelineMacro(_packet, _pipeline, _self)                                 \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            ...
            _rxEmbeddedPacketBetweenPipelines(fromPipeline, toPipeline);                           \
            _rxExecCtxGlobal.pipeline = toPipeline; /* modify */                                   \
            exitCode = toPipeline->nodes[0].nodeDef->nodeMethods.nodeBody(                         \
                &toPipeline->nodes[0], &(_rxExecCtxGlobal.params));                                \
            if (FALSE == exitCode)                                                                 \
                _rxExecCtxGlobal.exitCode = exitCode;                                              \
            _rxExecCtxGlobal.pipeline = fromPipeline; /* restore */                                \
        }                                                                                          \
        if (toPipeline->embeddedPacketState > rxPKST_UNUSED /* !UNUSED and !PACKETLESS */)         \
        {                                                                                          \
...
extern RxNodeDefinition* RxPipelineNodeCloneDefinition(RxPipelineNode* node,
                                                       RxClusterDefinition* cluster2add);

extern RxPipeline* RxPipelineNodeRequestCluster(RxPipeline* pipeline, RxPipelineNode* node,
                                                RxClusterDefinition* clusterDef);

extern RxPipeline* RxPipelineNodeReplaceCluster(RxPipeline* pipeline, RxPipelineNode* node,
...
extern RxPipeline* RxLockedPipeReplaceNode(RxLockedPipe* pipeline, RxPipelineNode* node,
...
extern RxPipeline* RxPipelineInsertDebugNode(RxPipeline* pipeline, RxPipelineNode* before,
                                             RxPipelineNode* after, RxNodeDefinition* debugNode);
...
#define RxObjSpace3DVertexSetPreLitColor(_vert, _col)                                              \
    ((_vert)->color = (((RwUInt32)(_col)->alpha) << 24) | (((RwUInt32)(_col)->red) << 16) |        \
                      (((RwUInt32)(_col)->green) << 8) | (((RwUInt32)(_col)->blue)))
...
/* Normals */
#define RxObjSpace3DVertexGetNormal(_vert, _normal) (*(_normal) = (_vert)->objNormal)
...
/* Vertex positions */
#define RxObjSpace3DLitVertexGetPos(_vert, _pos) (*(_pos) = (_vert)->objVertex)
#define RxObjSpace3DLitVertexSetPos(_vert, _pos) ((_vert)->objVertex = *(_pos))
...
/* Us and Vs */
#define RxObjSpace3DLitVertexGetU(_vert) ((_vert)->u)
#define RxObjSpace3DLitVertexGetV(_vert) ((_vert)->v)
#define RxObjSpace3DLitVertexSetU(_vert, _imu) ((_vert)->u = (_imu))
#define RxObjSpace3DLitVertexSetV(_vert, _imv) ((_vert)->v = (_imv))
...
extern RwBool RwImageRegisterImageFormat(const RwChar* extension, RwImageCallBackRead imageRead,
...
extern const RwImage* RwImageStreamWrite(const RwImage* image, RwStream* stream);
...
extern void RwPalQuantSetMaxDepth(RwUInt32 depth);

extern RwUInt32 RwPalQuantGetMaxDepth(void);
...
extern void RwPalQuantMatchImage(RwUInt8* dstpixels, RwInt32 dststride, RwInt32 dstdepth,
...
extern RwInt32 RwTextureRegisterPlugin(RwInt32 size, RwUInt32 pluginID,
                                       ...
                                       RwPluginObjectDestructor destructCB,
                                       RwPluginObjectCopy copyCB);
extern RwInt32 RwTexDictionaryRegisterPlugin(RwInt32 size, RwUInt32 pluginID,
                                             RwPluginObjectConstructor constructCB,
                                             RwPluginObjectDestructor destructCB,
                                             RwPluginObjectCopy copyCB);
...
/* Addressing */
extern RwTexture* RwTextureSetAddressing(RwTexture* texture, RwTextureAddressMode addressing);
extern RwTexture* RwTextureSetAddressingU(RwTexture* texture, RwTextureAddressMode addressing);
extern RwTexture* RwTextureSetAddressingV(RwTexture* texture, RwTextureAddressMode addressing);
...
#define RwTextureSetAutoMipMapState(_enable) _rwTextureSetAutoMipMapState(_enable)

#define RwTextureGetAutoMipMapState() _rwTextureGetAutoMipMapState()
...
struct RxCamSpace3DVertex
{
    ...
    RwUInt8
        clipFlags; /**< Clip flags for the vertex generated during transformation into camera-space, see \ref RwClipFlag */
    RwUInt8 pad[3]; /**< Alignment padding */
    /* Lit color */
    RwRGBAReal
        col; /**< Accumulated \ref RwReal light values (initialized to zero or prelight colors) */
...
enum RxGeometryFlag
{
    ...
    rxGEOMETRY_MODULATE =
        0x40, /**<This geometry will modulate the material color with the vertex colors (prelit + lit) */
...
struct RxMeshStateVector
{
    ...
    RwInt32
        ClipFlagsOr; /**< Boolean OR of the \ref RwClipFlag clip flags of all vertices in the mesh */
    RwInt32
        ClipFlagsAnd; /**< Boolean AND of the \ref RwClipFlag clip flags of all vertices in the mesh */
...
{
    RxVertexIndex
        originalVert; /**< \ref RxVertexIndex index to the new vertex generated on the clipped edge */
    RxVertexIndex
        parentVert1; /**< \ref RxVertexIndex index to the first vertex of the clipped edge */
    RxVertexIndex
        parentVert2; /**< \ref RxVertexIndex index to the second vertex of the clipped edge */
...
#define RWFRAMEALIGNMENT(_frame) (!(((rwFRAMEALIGNMENT)-1) & ((RwUInt32)(_frame))))
...
extern RwBool _rwFrameSetStaticPluginsSize(RwInt32 size);

extern RwBool _rwFrameInit(RwFrame* frame);
...
#define rwObjectHasFrameSync(o) ((RwObjectHasFrame*)(o))->sync(o)
...
extern RwInt32 RwTextureSetStreamAlwaysCallBack(RwUInt32 pluginID,
...
extern RwInt32 RwTexDictionarySetStreamAlwaysCallBack(RwUInt32 pluginID,
                                                      RwPluginDataChunkAlwaysCallBack alwaysCB);
...
extern const RwTexDictionary* RwTexDictionaryStreamWrite(const RwTexDictionary* texDict,
                                                         RwStream* stream);

extern RwTextureChunkInfo*
_rwTextureChunkInfoRead(RwStream* stream, RwTextureChunkInfo* textureChunkInfo, RwInt32* bytesRead);
...
extern RwInt32 RwFrameSetStreamAlwaysCallBack(RwUInt32 pluginID,
                                              RwPluginDataChunkAlwaysCallBack alwaysCB);
...
#define rwFrameListInitialize(frameList, frame) _rwFrameListInitialize(frameList, frame)

#define rwFrameListFindFrame(frameList, frame, index) _rwFrameListFindFrame(frameList, frame, index)

#define rwFrameListDeinitialize(frameList) _rwFrameListDeinitialize(frameList)

#define rwFrameListStreamGetSize(frameList) _rwFrameListStreamGetSize(frameList)

#define rwFrameListStreamRead(stream, fl) _rwFrameListStreamRead(stream, fl)

#define rwFrameListStreamWrite(frameList, stream) _rwFrameListStreamWrite(frameList, stream)
...
#define RwBBoxAssign(_target, _source) (*(_target) = *(_source))
...
extern RwInt32 RwCameraRegisterPluginStream(RwUInt32 pluginID, RwPluginDataChunkReadCallBack readCB,
                                            RwPluginDataChunkWriteCallBack writeCB,
                                            RwPluginDataChunkGetSizeCallBack getSizeCB);
extern RwInt32 RwCameraSetStreamAlwaysCallBack(RwUInt32 pluginID,
                                               RwPluginDataChunkAlwaysCallBack alwaysCB);
...
extern RwCameraChunkInfo*
RwCameraChunkInfoRead(RwStream* stream, RwCameraChunkInfo* cameraChunkInfo, RwInt32* bytesRead);
