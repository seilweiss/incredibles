...
extern RpSkin* RpSkinCreate(RwUInt32 numVertices, RwUInt32 numBones, RwMatrixWeights* vertexWeights,
...
#define RpSkinAtomicGetSkin(_a) RpSkinGeometryGetSkin(RpAtomicGetGeometry(_a))
