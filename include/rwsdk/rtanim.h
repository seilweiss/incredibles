 ...
 */
typedef RwBool (*RtAnimKeyFrameStreamWriteCallBack)(const RtAnimAnimation* animation,
                                                    RwStream* stream);
...
/* RtAnimAnimation */
extern RtAnimAnimation* RtAnimAnimationCreate(RwInt32 typeID, RwInt32 numFrames, RwInt32 flags,
                                              RwReal duration);
...
extern RwInt32 RtAnimAnimationGetTypeID(RtAnimAnimation* animation);
...
extern RwBool RtAnimInterpolatorSetKeyFrameCallBacks(RtAnimInterpolator* anim,
                                                     RwInt32 keyFrameTypeID);

extern void RtAnimInterpolatorSetAnimLoopCallBack(RtAnimInterpolator* anim, RtAnimCallBack callBack,
                                                  void* data);

extern void RtAnimInterpolatorSetAnimCallBack(RtAnimInterpolator* anim, RtAnimCallBack callBack,
...
extern RwBool RtAnimInterpolatorBlend(RtAnimInterpolator* outAnim, RtAnimInterpolator* inAnim1,
                                      RtAnimInterpolator* inAnim2, RwReal alpha);

extern RwBool RtAnimInterpolatorAddTogether(RtAnimInterpolator* outAnim,
...
extern void RtAnimKeyFrameInterpolate(RtAnimInterpolator* animation, void* out, void* in1,
                                      void* in2, RwReal time);

extern void RtAnimKeyFrameBlend(RtAnimInterpolator* animation, void* out, void* in1, void* in2,
                                RwReal alpha);

extern void RtAnimKeyFrameAddTogether(RtAnimInterpolator* animation, void* out, void* in1,
                                      void* in2);
...
extern RtAnimInterpolator* RtAnimInterpolatorCreateSubInterpolator(RtAnimInterpolator* parentAnim,
                                                                   RwInt32 startNode,
                                                                   RwInt32 numNodes,
                                                                   RwInt32 maxInterpKeyFrameSize);

extern RwBool RtAnimInterpolatorBlendSubInterpolator(RtAnimInterpolator* outAnim,
                                                     RtAnimInterpolator* inAnim1,
                                                     RtAnimInterpolator* inAnim2, RwReal alpha);

extern RwBool RtAnimInterpolatorAddSubInterpolator(RtAnimInterpolator* outAnim,
