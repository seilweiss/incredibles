...
#define RwMaterialAssign(_target, _source) (*(_target) = *(_source))
...
extern RpMaterial* RpMaterialSetSurfaceProperties(RpMaterial* material,
...
extern RwInt32 RpMaterialSetStreamAlwaysCallBack(RwUInt32 pluginID,
...
extern RpMaterialChunkInfo* _rpMaterialChunkInfoRead(RwStream* stream,
...
#define rpMaterialListInitialize(_matList) _rpMaterialListInitialize(_matList)

#define rpMaterialListDeinitialize(_matList) _rpMaterialListDeinitialize(_matList)

#define rpMaterialListGetMaterial(_matList, _matIndex)                                             \
    _rpMaterialListGetMaterial(_matList, _matIndex)

#define rpMaterialListCopy(_matListOut, _matListIn) _rpMaterialListCopy(_matListOut, _matListIn)

#define rpMaterialListAppendMaterial(_matList, _material)                                          \
    _rpMaterialListAppendMaterial(_matList, _material)

#define rpMaterialListStreamRead(_stream, _matList) _rpMaterialListStreamRead(_stream, _matList)

#define rpMaterialListStreamWrite(_matList, _stream) _rpMaterialListStreamWrite(_matList, _stream)
...
#define rpMESHHEADERPRIMTYPEOR                                                                     \
    (0 /* rpMESHHEADERTRILIST*/ | rpMESHHEADERTRISTRIP | rpMESHHEADERTRIFAN |                      \
     rpMESHHEADERLINELIST | rpMESHHEADERPOLYLINE | rpMESHHEADERPOINTLIST)
...
#define RpMeshHeaderGetPrimType(_mshHdr)                                                           \
    ((RwPrimitiveType)RPMESHGLOBAL(meshFlagsToPrimType)[(_mshHdr)->flags & rpMESHHEADERPRIMMASK])

#define RpMeshHeaderSetPrimType(_mshHdr, _prmTyp)                                                  \
    ((_mshHdr)->flags = ((_mshHdr)->flags & ~rpMESHHEADERPRIMMASK) |                               \
                        (rpMESHHEADERPRIMMASK &                                                    \
                         RPMESHGLOBAL(primTypeToMeshFlags)[(_prmTyp)&rpMESHHEADERPRIMMASK]),       \
     (_mshHdr))
...
extern RwPrimitiveType RpMeshHeaderGetPrimType(RpMeshHeader* meshHeader);

/* Set primtype for a mesh header */
extern RpMeshHeader* RpMeshHeaderSetPrimType(RpMeshHeader* meshHeader, RwPrimitiveType primType);
 ...
 */
typedef RwUInt32 (*RpTriStripCostCallBack)(RpTriStripPolygon* startPolygon, RwUInt32 testFrame,
                                           void* data);
...
extern RpTriStripPolygon* RpTriStripPolygonFollowStrip(RpTriStripPolygon* curr,
                                                       RpTriStripPolygon* prev);

/* Callback strip costing functions */
extern RwUInt32 RpTriStripDefaultCost(RpTriStripPolygon* startPolygon, RwUInt32 testFrame,
                                      void* data);
...
extern RpMeshHeader* RpBuildMeshGenerateDefaultIgnoreWindingTriStrip(RpBuildMesh* buildmesh,
                                                                     void* data);

extern RpMeshHeader* RpBuildMeshGeneratePreprocessIgnoreWindingTriStrip(RpBuildMesh* buildmesh,
                                                                        void* data);

extern RpMeshHeader* RpBuildMeshGenerateExhaustiveIgnoreWindingTriStrip(RpBuildMesh* buildmesh,
                                                                        void* data);
...
#define _rpMeshSetTristripMethod(_callback, _data) RpMeshSetTriStripMethod(_callback, _data)

#define _rpMeshGetTristripMethod(_callback, _data) RpMeshGetTriStripMethod(_callback, _data)
...
struct RpGeometry
{
    ...
    RwUInt16
        lockedSinceLastInst; /* What has been locked since we last instanced - for re-instancing */
 ...
 */
typedef void (*RpGeometrySortByMaterialCallBack)(const RpGeometry* oldGeom, RpGeometry* newGeom,
                                                 RwUInt16* remapTable, RwUInt16 numberOfEntries);
...
extern RpMorphTarget* RpMorphTargetSetBoundingSphere(RpMorphTarget* morphTarget,
                                                     const RwSphere* boundingSphere);

extern RwSphere* RpMorphTargetGetBoundingSphere(RpMorphTarget* morphTarget);
...
#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))
extern RwInt32 RpGeometryGetNumMorphTargets(const RpGeometry* geometry);

extern RpMorphTarget* RpGeometryGetMorphTarget(const RpGeometry* geometry, RwInt32 morphTarget);

extern RwRGBA* RpGeometryGetPreLightColors(const RpGeometry* geometry);

extern RwTexCoords* RpGeometryGetVertexTexCoords(const RpGeometry* geometry,
                                                 RwTextureCoordinateIndex uvIndex);

extern RwInt32 RpGeometryGetNumTexCoordSets(const RpGeometry* geometry);
...
extern RwInt32 RpGeometryGetNumTriangles(const RpGeometry* geometry);
...
extern const RpGeometry* RpGeometryForAllMeshes(const RpGeometry* geometry,
...
extern RpGeometry* RpGeometryAddRef(RpGeometry* geometry);
...
extern RwInt32 RpGeometrySetStreamAlwaysCallBack(RwUInt32 pluginID,
                                                 RwPluginDataChunkAlwaysCallBack alwaysCB);
...
extern RpGeometryChunkInfo* _rpGeometryChunkInfoRead(RwStream* stream,
...
extern RpGeometry* RpGeometrySetFlags(RpGeometry* geometry, RwUInt32 flags);
...
#define rpGeometryAddRef(_geometry) RpGeometryAddRef(_geometry)
...
#define RpWorldSectorGetBBoxMacro(_sector) (&((_sector)->boundingBox))

#define RpWorldSectorGetTightBBoxMacro(_sector) (&((_sector)->tightBoundingBox))

#define RpWorldSectorGetNumVerticesMacro(_sector) ((_sector)->numVertices)

#define RpWorldSectorGetNumTrianglesMacro(_sector) ((_sector)->numTriangles)

#define RpWorldSectorGetTrianglesMacro(_sector) ((_sector)->triangles)

#define RpWorldSectorGetVerticesMacro(_sector) ((_sector)->vertices)

#if ((!defined(RWDEBUG)) && (!defined(RWSUPPRESSINLINE)))

#define RpWorldSectorGetBBox(_sector) RpWorldSectorGetBBoxMacro(_sector)

#define RpWorldSectorGetTightBBox(_sector) RpWorldSectorGetTightBBoxMacro(_sector)

#define RpWorldSectorGetNumTriangles(_sector) RpWorldSectorGetNumTrianglesMacro(_sector)

#define RpWorldSectorGetNumVertices(_sector) RpWorldSectorGetNumVerticesMacro(_sector)

#define RpWorldSectorGetTriangles(_sector) RpWorldSectorGetTrianglesMacro(_sector)

#define RpWorldSectorGetVertices(_sector) RpWorldSectorGetVerticesMacro(_sector)

#endif /* ((!defined(RWDEBUG)) && (!defined(RWSUPPRESSINLINE))) */

/* Backward compatibility */
#define RpWorldSectorGetNumPolygons(_sector) RpWorldSectorGetNumTriangles(_sector)
...
extern const RwV3d* RpWorldSectorGetVertices(const RpWorldSector* sector);

extern const RpTriangle* RpWorldSectorGetTriangles(const RpWorldSector* sector);
...
extern RwInt32 RpWorldSectorRegisterPluginStream(RwUInt32 pluginID,
                                                 ...
                                                 RwPluginDataChunkWriteCallBack writeCB,
                                                 RwPluginDataChunkGetSizeCallBack getSizeCB);
extern RwInt32 RpWorldSectorSetStreamAlwaysCallBack(RwUInt32 pluginID,
                                                    RwPluginDataChunkAlwaysCallBack alwaysCB);
...
extern const RpLight* RpLightStreamWrite(const RpLight* light, RwStream* stream);
extern RpLightChunkInfo* _rpLightChunkInfoRead(RwStream* stream, RpLightChunkInfo* lightChunkInfo,
                                               RwInt32* bytesRead);
...
extern RpClumpChunkInfo* _rpClumpChunkInfoRead(RwStream* stream, RpClumpChunkInfo* clumpChunkInfo,
                                               RwInt32* bytesRead);
...
extern RwInt32 RpClumpRegisterPluginStream(RwUInt32 pluginID, RwPluginDataChunkReadCallBack readCB,
                                           RwPluginDataChunkWriteCallBack writeCB,
                                           RwPluginDataChunkGetSizeCallBack getSizeCB);

extern RwInt32 RpClumpSetStreamAlwaysCallBack(RwUInt32 pluginID,
                                              RwPluginDataChunkAlwaysCallBack alwaysCB);
...
#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))
extern RwFrame* RpAtomicGetFrame(const RpAtomic* atomic);

extern RwFrame* RpClumpGetFrame(const RpClump* clump);

extern RpClump* RpClumpSetFrame(RpClump* clump, RwFrame* frame);

/* Flags */
extern RpAtomic* RpAtomicSetFlags(RpAtomic* atomic, RwUInt32 flags);

extern RwUInt32 RpAtomicGetFlags(const RpAtomic* atomic);

extern RwSphere* RpAtomicGetBoundingSphere(RpAtomic* atomic);

extern RwInt32 RpInterpolatorGetEndMorphTarget(const RpInterpolator* interpolator);

extern RwInt32 RpInterpolatorGetStartMorphTarget(const RpInterpolator* interpolator);

extern RwReal RpInterpolatorGetValue(const RpInterpolator* interpolator);

extern RwReal RpInterpolatorGetScale(const RpInterpolator* interpolator);

extern RpInterpolator* RpInterpolatorSetEndMorphTarget(RpInterpolator* interpolator,
                                                       RwInt32 morphTarget, RpAtomic* atomic);

extern RpInterpolator* RpInterpolatorSetStartMorphTarget(RpInterpolator* interpolator,
                                                         RwInt32 morphTarget, RpAtomic* atomic);

extern RpInterpolator* RpInterpolatorSetValue(RpInterpolator* interpolator, RwReal value,
                                              RpAtomic* atomic);

extern RpInterpolator* RpInterpolatorSetScale(RpInterpolator* interpolator, RwReal scale,
                                              RpAtomic* atomic);

extern RpAtomic* RpAtomicRender(RpAtomic* atomic);

/* Building clumps */
extern RpClump* RpAtomicGetClump(const RpAtomic* atomic);

extern RpInterpolator* RpAtomicGetInterpolator(RpAtomic* atomic);
...
extern RpWorldSector* _rpWorldSectorForAllLocalLights(RpWorldSector* sector,
...
extern RwInt32 RpWorldRegisterPluginStream(RwUInt32 pluginID, RwPluginDataChunkReadCallBack readCB,
                                           RwPluginDataChunkWriteCallBack writeCB,
                                           RwPluginDataChunkGetSizeCallBack getSizeCB);
extern RwInt32 RpWorldSetStreamAlwaysCallBack(RwUInt32 pluginID,
                                              RwPluginDataChunkAlwaysCallBack alwaysCB);
...
/* Render order */
extern RpWorld* RpWorldSetRenderOrder(RpWorld* world, RpWorldRenderOrder renderOrder);
...
#define rpWorldFindBBox(_world, _boundingBox) _rpWorldFindBBox(_world, _boundingBox)

#define rpWorldForAllGlobalLights(_callBack, _pData) _rpWorldForAllGlobalLights(_callBack, _pData)

#define rpWorldSectorForAllLocalLights(_sector, _callBack, _pData)                                 \
    _rpWorldSectorForAllLocalLights(_sector, _callBack, _pData)

#define _rpWorldLock(_world) RpWorldLock(_world)

#define _rpWorldUnlock(_world) RpWorldUnlock(_world)

#define rpWorldLock(_world) RpWorldLock(_world)

#define rpWorldUnlock(_world) RpWorldUnlock(_world)

#define RpWorldGetDefaultSectorPipelineMacro() (RXPIPELINEGLOBAL(currentWorldSectorPipeline))

#define RpWorldSetSectorPipelineMacro(_world, _pipeline) (((_world)->pipeline = _pipeline), _world)
...
#define RpAtomicGetDefaultPipelineMacro() (RXPIPELINEGLOBAL(currentAtomicPipeline))
...
#define RpMaterialGetDefaultPipelineMacro() (RXPIPELINEGLOBAL(currentMaterialPipeline))
...
extern RpWorld* RpWorldSetSectorPipeline(RpWorld* world, RxPipeline* pipeline);
extern RpWorld* RpWorldGetSectorPipeline(RpWorld* world, RxPipeline** pipeline);
extern RpWorldSector* RpWorldSectorSetPipeline(RpWorldSector* sector, RxPipeline* pipeline);
extern RpWorldSector* RpWorldSectorGetPipeline(RpWorldSector* sector, RxPipeline** pipeline);

extern RxPipeline* RpAtomicGetGenericPipeline(void);
extern RxPipeline* RpAtomicGetDefaultPipeline(void);
extern RpAtomic* RpAtomicSetPipeline(RpAtomic* atomic, RxPipeline* pipeline);
extern const RpAtomic* RpAtomicGetPipeline(const RpAtomic* const atomic, RxPipeline** pipeline);

extern RxPipeline* RpMaterialGetGenericPipeline(void);
extern RxPipeline* RpMaterialGetDefaultPipeline(void);
extern RpMaterial* RpMaterialSetPipeline(RpMaterial* material, RxPipeline* pipeline);
extern RpMaterial* RpMaterialGetPipeline(RpMaterial* material, RxPipeline** pipeline);
...
extern RwCamera* RwCameraForAllAtomicsInFrustum(RwCamera* camera, RpAtomicCallBack callback,
                                                void* data);
...
extern RpLight* RpLightForAllWorldSectors(RpLight* light, RpWorldSectorCallBack callback,
                                          void* data);
extern RpAtomic* RpAtomicForAllWorldSectors(RpAtomic* atomic, RpWorldSectorCallBack callback,
                                            void* data);
extern RpWorldSector* RpWorldSectorForAllAtomics(RpWorldSector* sector, RpAtomicCallBack callback,
                                                 void* data);
extern RpWorldSector* RpWorldSectorForAllCollisionAtomics(RpWorldSector* sector,
                                                          RpAtomicCallBack callback, void* data);
extern RpWorldSector* RpWorldSectorForAllLights(RpWorldSector* sector, RpLightCallBack callback,
                                                void* data);
