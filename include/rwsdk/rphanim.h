...
enum RpHAnimHierarchyFlag
{
    ...
    rpHANIMHIERARCHYUPDATEMODELLINGMATRICES =
        0x1000, /**< This hierarchy updates modeling matrices */
...
#define RpHAnimHierarchyGetFlagsMacro(hierarchy) ((hierarchy)->flags)
...
#define RpHAnimHierarchySetFlags(hierarchy, _flags) RpHAnimHierarchySetFlagsMacro(hierarchy, _flags)
...
extern RpHAnimHierarchy* RpHAnimHierarchySetFlags(RpHAnimHierarchy* hierarchy,
                                                  RpHAnimHierarchyFlag flags);

extern RpHAnimHierarchyFlag RpHAnimHierarchyGetFlags(RpHAnimHierarchy* hierarchy);
...
extern RpHAnimHierarchy* RpHAnimHierarchyCreateFromHierarchy(RpHAnimHierarchy* hierarchy,
                                                             RpHAnimHierarchyFlag flags,
                                                             RwInt32 maxInterpKeyFrameSize);

extern RpHAnimHierarchy* RpHAnimHierarchyDestroy(RpHAnimHierarchy* hierarchy);

extern RpHAnimHierarchy* RpHAnimHierarchyCreateSubHierarchy(RpHAnimHierarchy* parentHierarchy,
                                                            RwInt32 startNode,
                                                            RpHAnimHierarchyFlag flags,
                                                            RwInt32 maxInterpKeyFrameSize);

extern RtAnimAnimation* RpHAnimRemoveDuplicates(RtAnimAnimation* animsrc, RwInt32 numBones,
                                                RwReal tolerance, RwReal averageNodeSize);

extern RtAnimAnimation* RpHAnimRemoveInterpolate(RtAnimAnimation* animsrc, RwInt32 numBones,
                                                 RwReal tolerance, RwReal averageNodeSize);

extern RtAnimAnimation* RpHAnimRemoveInterpolateLoop(RtAnimAnimation* animsrc, RwInt32 numBones,
                                                     RwReal tolerance, RwReal averageNodeSize);

extern RtAnimAnimation* RpHAnimRemoveInterpolatesLoopLength(RtAnimAnimation* animsrc,
                                                            RwUInt32* pushpops, RwInt32 numBones,
                                                            RwReal tolerance,
                                                            RwReal averageNodeSize);

extern RtAnimAnimation* RpHAnimRemoveNoLeafChange(RtAnimAnimation* animsrc, RwUInt32* pushpops,
                                                  RwInt32 numBones, RwReal tolerance,
                                                  RwReal averageNodeSize);
...
extern RpHAnimHierarchy* RpHAnimHierarchyAttachFrameIndex(RpHAnimHierarchy* hierarchy,
                                                          RwInt32 nodeIndex);

extern RpHAnimHierarchy* RpHAnimHierarchyDetachFrameIndex(RpHAnimHierarchy* hierarchy,
                                                          RwInt32 nodeIndex);
...
#define RpHAnimSetHierarchy(frame, hierarchy) RpHAnimFrameSetHierarchy(frame, hierarchy)
...
#define RpHAnimHierarchySetKeyFrameCallBacksMacro(hierarchy, keyFrameTypeID)                       \
    RtAnimInterpolatorSetKeyFrameCallBacks((hierarchy)->currentAnim, keyFrameTypeID)

#define RpHAnimHierarchyBlendMacro(outHierarchy, inHierarchy1, inHierarchy2, alpha)                \
    RtAnimInterpolatorBlend((outHierarchy)->currentAnim, (inHierarchy1)->currentAnim,              \
                            (inHierarchy2)->currentAnim, alpha)

#define RpHAnimHierarchyAddTogetherMacro(outHierarchy, inHierarchy1, inHierarchy2)                 \
    RtAnimInterpolatorAddTogether((outHierarchy)->currentAnim, (inHierarchy1)->currentAnim,        \
...
#define RpHAnimHierarchyBlendSubHierarchyMacro(outHierarchy, inHierarchy1, inHierarchy2, alpha)    \
    RtAnimInterpolatorBlendSubInterpolator((outHierarchy)->currentAnim,                            \
...
#define RpHAnimHierarchyAddSubHierarchyMacro(outHierarchy, mainHierarchy, subHierarchy)            \
    RtAnimInterpolatorAddSubInterpolator(                                                          \
        (outHierarchy)->currentAnim, (mainHierarchy)->currentAnim, (subHierarchy)->currentAnim)
...
#ifdef RWDEBUG
extern RwBool RpHAnimHierarchySetCurrentAnim(RpHAnimHierarchy* hierarchy, RtAnimAnimation* anim);

extern RtAnimAnimation* RpHAnimHierarchyGetCurrentAnim(RpHAnimHierarchy* hierarchy);

extern RwBool RpHAnimHierarchySetCurrentAnimTime(RpHAnimHierarchy* hierarchy, RwReal time);

extern RwBool RpHAnimHierarchyAddAnimTime(RpHAnimHierarchy* hierarchy, RwReal time);

extern RwBool RpHAnimHierarchySubAnimTime(RpHAnimHierarchy* hierarchy, RwReal time);

extern RwBool RpHAnimHierarchySetKeyFrameCallBacks(RpHAnimHierarchy* hierarchy,
                                                   RwInt32 keyFrameTypeID);

extern void RpHAnimHierarchySetAnimCallBack(RpHAnimHierarchy* hierarchy, RtAnimCallBack callBack,
                                            RwReal time, void* data);

extern RwBool RpHAnimHierarchyBlend(RpHAnimHierarchy* outHierarchy, RpHAnimHierarchy* inHierarchy1,
                                    RpHAnimHierarchy* inHierarchy2, RwReal alpha);

extern RwBool RpHAnimHierarchyAddTogether(RpHAnimHierarchy* outHierarchy,
                                          RpHAnimHierarchy* inHierarchy1,
                                          RpHAnimHierarchy* inHierarchy2);

extern void RpHAnimHierarchySetAnimLoopCallBack(RpHAnimHierarchy* hierarchy,
                                                RtAnimCallBack callBack, void* data);
extern RwBool RpHAnimHierarchyBlendSubHierarchy(RpHAnimHierarchy* outHierarchy,
                                                RpHAnimHierarchy* inHierarchy1,
                                                RpHAnimHierarchy* inHierarchy2, RwReal alpha);
extern RwBool RpHAnimHierarchyAddSubHierarchy(RpHAnimHierarchy* outHierarchy,
                                              RpHAnimHierarchy* mainHierarchy1,
                                              RpHAnimHierarchy* subHierarchy2);
extern RwBool RpHAnimHierarchyCopy(RpHAnimHierarchy* outHierarchy, RpHAnimHierarchy* inHierarchy);
...
#define RpHAnimHierarchyGetCurrentAnim(hierarchy) RpHAnimHierarchyGetCurrentAnimMacro((hierarchy))
...
#define RpHAnimAnimationDestroy(animation) RtAnimAnimationDestroy((animation))

#define RpHAnimAnimationGetTypeID(animation) RtAnimAnimationGetTypeID((animation))

#define RpHAnimAnimationRead(filename) RtAnimAnimationRead((filename))

#define RpHAnimAnimationWrite(animation, filename) RtAnimAnimationWrite((animation), (filename))

#define RpHAnimAnimationStreamRead(stream) RtAnimAnimationStreamRead((stream))

#define RpHAnimAnimationStreamWrite(animation, stream)                                             \
    RtAnimAnimationStreamWrite((animation), (stream))

#define RpHAnimAnimationStreamGetSize(animation) RtAnimAnimationStreamGetSize((animation))
