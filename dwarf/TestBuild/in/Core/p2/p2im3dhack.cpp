...
typedef int32(*type_4)(RxPS2AllPipeData*, void**, uint32);
...
// Start address: 0x170eb0
void p2EnableFastIm3D()
{
	// Line 92, Address: 0x170eb0, Func Offset: 0
	// Func End, Address: 0x170eb8, Func Offset: 0x8
}
