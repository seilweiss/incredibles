...
typedef xSphere type_62[5];
typedef int8 type_63[32];
typedef xVec3 type_64[4];
typedef xVec3 type_66[3];
typedef xAnimMultiFileEntry type_70[1];
...
// init__Q21z6symbolFv
// Start address: 0x2c3170
void init()
{
	// Line 39, Address: 0x2c3170, Func Offset: 0
	// Func End, Address: 0x2c3178, Func Offset: 0x8
}
